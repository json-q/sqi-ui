...
`},20035:function(x,t){"use strict";t.Z=`import React from 'react';
...
`},15063:function(x,t){"use strict";t.Z=`import React from 'react';
import { Button, Popup, Space } from '@sqi-ui/web';
export default function Demo() {
