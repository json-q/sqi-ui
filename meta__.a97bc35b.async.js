...
`},27833:function(x,t,e){"use no memo";"use strict";var n=Object.create,m=Object.defineProperty,r=Object.getOwnPropertyDescriptor,p=Object.getOwnPropertyNames,s=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,v=(P,S)=>{for(var W in S)m(P,W,{get:S[W],enumerable:!0})},I=(P,S,W,X)=>{if(S&&typeof S=="object"||typeof S=="function")for(let A of p(S))!a.call(P,A)&&A!==W&&m(P,A,{get:()=>S[A],enumerable:!(X=r(S,A))||X.enumerable});return P},h=(P,S,W)=>(W=P!=null?n(s(P)):{},I(S||!P||!P.__esModule?m(W,"default",{value:P,enumerable:!0}):W,P)),u=P=>I(m({},"__esModule",{value:!0}),P),c={};v(c,{$dispatcherGuard:()=>k,$makeReadOnly:()=>N,$reset:()=>ne,$structuralCheck:()=>te,c:()=>g,clearRenderCounterRegistry:()=>z,renderCounterRegistry:()=>O,useRenderCounter:()=>V}),x.exports=u(c);var d=h(e(53360)),{useRef:l,useEffect:f,isValidElement:i}=d,o,R=(o=d.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE)!=null?o:d.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,E=Symbol.for("react.memo_cache_sentinel"),T,g=typeof((T=d.__COMPILER_RUNTIME)==null?void 0:T.c)=="function"?d.__COMPILER_RUNTIME.c:function(S){return d.useMemo(()=>{const W=new Array(S);for(let X=0;X<S;X++)W[X]=E;return W[E]=!0,W},[])},M={};["readContext","useCallback","useContext","useEffect","useImperativeHandle","useInsertionEffect","useLayoutEffect","useMemo","useReducer","useRef","useState","useDebugValue","useDeferredValue","useTransition","useMutableSource","useSyncExternalStore","useId","unstable_isNewReconciler","getCacheSignal","getCacheForType","useCacheRefresh"].forEach(P=>{M[P]=()=>{throw new Error(`[React] Unexpected React hook call (${P}) from a React compiled function. Check that all hooks are called directly and named according to convention ('use[A-Z]') `)}});var B=null;M.useMemoCache=P=>{if(B==null)throw new Error("React Compiler internal invariant violation: unexpected null dispatcher");return B.useMemoCache(P)};function w(P){return R.ReactCurrentDispatcher.current=P,R.ReactCurrentDispatcher.current}var Y=[];function k(P){const S=R.ReactCurrentDispatcher.current;if(P===0){if(Y.push(S),Y.length===1&&(B=S),S===M)throw new Error("[React] Unexpected call to custom hook or component from a React compiled function. Check that (1) all hooks are called directly and named according to convention ('use[A-Z]') and (2) components are returned as JSX instead of being directly invoked.");w(M)}else if(P===1){const W=Y.pop();if(W==null)throw new Error("React Compiler internal error: unexpected null in guard stack");Y.length===0&&(B=null),w(W)}else if(P===2)Y.push(S),w(B);else if(P===3){const W=Y.pop();if(W==null)throw new Error("React Compiler internal error: unexpected null in guard stack");w(W)}else throw new Error("React Compiler internal error: unreachable block"+P)}function ne(P){for(let S=0;S<P.length;S++)P[S]=E}function N(){throw new Error("TODO: implement $makeReadOnly in react-compiler-runtime")}var O=new Map;function z(){for(const P of O.values())P.forEach(S=>{S.count=0})}function $(P,S){let W=O.get(P);W==null&&(W=new Set,O.set(P,W)),W.add(S)}function J(P,S){const W=O.get(P);W!=null&&W.delete(S)}function V(P){const S=l(null);S.current!=null&&(S.current.count+=1),f(()=>{if(S.current==null){const W={count:0};$(P,W),S.current=W}return()=>{S.current!==null&&J(P,S.current)}})}var j=new Set;function te(P,S,W,X,A,xe){function F(D,L,q,b){const ve=`${X}:${xe} [${A}] ${W}${q} changed from ${D} to ${L} at depth ${b}`;j.has(ve)||(j.add(ve),console.error(ve))}const ie=2;function pe(D,L,q,b){if(!(b>ie)){if(D===L)return;if(typeof D!=typeof L)F(`type ${typeof D}`,`type ${typeof L}`,q,b);else if(typeof D=="object"){const ve=Array.isArray(D),ye=Array.isArray(L);if(D===null&&L!==null)F("null",`type ${typeof L}`,q,b);else if(L===null)F(`type ${typeof D}`,"null",q,b);else if(D instanceof Map)if(!(L instanceof Map))F("Map instance","other value",q,b);else if(D.size!==L.size)F(`Map instance with size ${D.size}`,`Map instance with size ${L.size}`,q,b);else for(const[_,ge]of D)L.has(_)?pe(ge,L.get(_),`${q}.get(${_})`,b+1):F(`Map instance with key ${_}`,`Map instance without key ${_}`,q,b);else if(L instanceof Map)F("other value","Map instance",q,b);else if(D instanceof Set)if(!(L instanceof Set))F("Set instance","other value",q,b);else if(D.size!==L.size)F(`Set instance with size ${D.size}`,`Set instance with size ${L.size}`,q,b);else for(const _ of L)D.has(_)||F(`Set instance without element ${_}`,`Set instance with element ${_}`,q,b);else if(L instanceof Set)F("other value","Set instance",q,b);else if(ve||ye)if(ve!==ye)F(`type ${ve?"array":"object"}`,`type ${ye?"array":"object"}`,q,b);else if(D.length!==L.length)F(`array with length ${D.length}`,`array with length ${L.length}`,q,b);else for(let _=0;_<D.length;_++)pe(D[_],L[_],`${q}[${_}]`,b+1);else if(i(D)||i(L))i(D)!==i(L)?F(`type ${i(D)?"React element":"object"}`,`type ${i(L)?"React element":"object"}`,q,b):D.type!==L.type?F(`React element of type ${D.type}`,`React element of type ${L.type}`,q,b):pe(D.props,L.props,`[props of ${q}]`,b+1);else{for(const _ in L)_ in D||F(`object without key ${_}`,`object with key ${_}`,q,b);for(const _ in D)_ in L?pe(D[_],L[_],`${q}.${_}`,b+1):F(`object with key ${_}`,`object without key ${_}`,q,b)}}else{if(typeof D=="function")return;isNaN(D)||isNaN(L)?isNaN(D)!==isNaN(L)&&F(`${isNaN(D)?"NaN":"non-NaN value"}`,`${isNaN(L)?"NaN":"non-NaN value"}`,q,b):D!==L&&F(D,L,q,b)}}}pe(P,S,"",0)}},11607:function(x,t){"use strict";var e=Symbol.for("react.transitional.element"),n=Symbol.for("react.portal"),m=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),p=Symbol.for("react.profiler");Symbol.for("react.provider");var s=Symbol.for("react.consumer"),a=Symbol.for("react.context"),v=Symbol.for("react.forward_ref"),I=Symbol.for("react.suspense"),h=Symbol.for("react.suspense_list"),u=Symbol.for("react.memo"),c=Symbol.for("react.lazy"),d=Symbol.for("react.view_transition"),l=Symbol.for("react.client.reference");function f(i){if(typeof i=="object"&&i!==null){var o=i.$$typeof;switch(o){case e:switch(i=i.type,i){case m:case p:case r:case I:case h:case d:return i;default:switch(i=i&&i.$$typeof,i){case a:case v:case c:case u:return i;case s:return i;default:return o}}case n:return o}}}t.ContextConsumer=s,t.ContextProvider=a,t.Element=e,t.ForwardRef=v,t.Fragment=m,t.Lazy=c,t.Memo=u,t.Portal=n,t.Profiler=p,t.StrictMode=r,t.Suspense=I,t.SuspenseList=h,t.isContextConsumer=function(i){return f(i)===s},t.isContextProvider=function(i){return f(i)===a},t.isElement=function(i){return typeof i=="object"&&i!==null&&i.$$typeof===e},t.isForwardRef=function(i){return f(i)===v},t.isFragment=function(i){return f(i)===m},t.isLazy=function(i){return f(i)===c},t.isMemo=function(i){return f(i)===u},t.isPortal=function(i){return f(i)===n},t.isProfiler=function(i){return f(i)===p},t.isStrictMode=function(i){return f(i)===r},t.isSuspense=function(i){return f(i)===I},t.isSuspenseList=function(i){return f(i)===h},t.isValidElementType=function(i){return typeof i=="string"||typeof i=="function"||i===m||i===p||i===r||i===I||i===h||typeof i=="object"&&i!==null&&(i.$$typeof===c||i.$$typeof===u||i.$$typeof===a||i.$$typeof===s||i.$$typeof===v||i.$$typeof===l||i.getModuleId!==void 0)},t.typeOf=f},81184:function(x,t,e){"use strict";x.exports=e(11607)},37797:function(x,t,e){"use strict";e.d(t,{D:function(){return m}});var n=e(53360);function m(r,p,s){const a=(0,n.useRef)({});return(!("value"in a.current)||s(a.current.condition,p))&&(a.current.value=r(),a.current.condition=p),a.current.value}},60164:function(x,t,e){"use strict";e.d(t,{L:function(){return p}});var n=e(53360),m=e(34028);const p=(0,m.J)()?n.useLayoutEffect:n.useEffect},7657:function(x,t,e){"use strict";e.d(t,{S:function(){return m}});var n=e(53360);function m(r){let p=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};return(0,n.useMemo)(()=>{const a=K(K({},p),s),v=K({},r);for(const I in a)v[I]===void 0&&(v[I]=a[I]);return v},[r,p,s])}},62222:function(x,t,e){"use strict";e.d(t,{R:function(){return p}});var n=e(53360),m=e(80703),r=e(45844);function p(s,a){const{defaultValue:v,value:I,onChange:h}=a||{},[u,c]=(0,n.useState)(()=>(0,m.o8)(I)?(0,m.o8)(v)?(0,m.mf)(s)?s():s:(0,m.mf)(v)?v():v:I),d=(0,r.D)(I),l=(0,n.useRef)(!0);(0,n.useEffect)(()=>{if(l.current){l.current=!1;return}(0,m.o8)(I)&&d.current!==I&&c(I)},[I]);const f=(0,m.o8)(I)?u:I,i=(0,n.useCallback)(o=>{const R=(0,m.mf)(o)?o(f):o;(0,m.o8)(I)&&c(R),!Object.is(R,f)&&(h==null||h(R))},[I,f,h]);return[f,i]}},45844:function(x,t,e){"use strict";e.d(t,{D:function(){return m}});var n=e(53360);function m(r){const p=(0,n.useRef)(void 0);return(0,n.useEffect)(()=>{p.current=r},[r]),p}},8240:function(x,t,e){"use strict";e.d(t,{y:function(){return s}});var n=e(53360),m=e(20759),r=e(34028),p=e(60164);function s(a,v){let I=arguments.length>2&&arguments[2]!==void 0?arguments[2]:!0;const h=(0,n.useRef)(null);h.current=v,(0,p.L)(()=>{let u=null;if(!I||!(0,r.J)()||!a)return;const c=d=>{var l;(l=h.current)==null||l.call(h,d)};return u=new m.Z(c),u.observe(a),()=>{if(u&&a){var d;u.unobserve(a),(d=u.disconnect)==null||d.call(u),u=null}}},[a,I])}},31136:function(x,t,e){"use strict";e.d(t,{Z:function(){return r}});var n=e(53360);const r=(0,n.createContext)({})},37907:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(7829),r=e(31136);const p=(0,n.forwardRef)((a,v)=>{const E=a,{svg:I,type:h,spin:u,rotate:c,className:d,style:l}=E,f=Ue(E,["svg","type","spin","rotate","className","style"]),{prefixCls:i="sqi"}=(0,n.useContext)(r.Z),o=(0,m.default)(`${i}-icon`,{[`${i}-icon-spin`]:!!u&&!!I},d),R=l||{};return Number.isSafeInteger(c)&&(R.transform=`rotate(${c}deg)`),n.createElement("span",K({role:"img",ref:v,"aria-label":h,className:o,style:R},f),I)});p.displayName="Icon";const s=p},46874:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M13 4V11L20 11V13L13 13V20H11L11 13H4L4 11L11 11L11 4L13 4Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"add",ref:v},a)));p.displayName="AddIcon";const s=p},1824:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("g",{clipPath:"url(#clip0_8726_7319)"},(0,n.createElement)("path",{d:"M2.09675 12C3.53842 16.0792 7.42915 19 11.9996 19C16.57 19 20.4607 16.0792 21.9024 12C20.4607 7.92079 16.57 5 11.9996 5C7.42915 5 3.53842 7.92079 2.09675 12ZM0.0892162 11.696C1.69842 6.65364 6.42102 3 11.9996 3C17.5781 3 22.3007 6.65364 23.9099 11.696L24.007 12L23.9099 12.304C22.3007 17.3464 17.5781 21 11.9996 21C6.42102 21 1.69842 17.3464 0.0892162 12.304L-0.0078125 12L0.0892162 11.696ZM11.9999 9C10.343 9 8.99989 10.3431 8.99989 12C8.99989 13.6569 10.343 15 11.9999 15C13.6567 15 14.9999 13.6569 14.9999 12C14.9999 10.3431 13.6567 9 11.9999 9ZM6.99989 12C6.99989 9.23858 9.23846 7 11.9999 7C14.7613 7 16.9999 9.23858 16.9999 12C16.9999 14.7614 14.7613 17 11.9999 17C9.23846 17 6.99989 14.7614 6.99989 12Z",fill:"currentColor"})))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"browse",ref:v},a)));p.displayName="BrowseIcon";const s=p},85569:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 26 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M3.99999 1.58582L10.1714 7.75774L17.2425 14.8288L23.4137 21L21.9995 22.4142L19.0345 19.4492C17.2447 20.4377 15.1866 21.0001 12.9996 21.0001C7.42102 21.0001 2.69842 17.3465 1.08922 12.3042L0.992188 12.0001L1.08922 11.6961C1.85645 9.29201 3.33009 7.20571 5.26511 5.67975L2.58567 2.99993L3.99999 1.58582ZM6.69098 7.10574C5.05507 8.33729 3.79122 10.0353 3.09676 12.0001C4.53843 16.0793 8.42915 19.0001 12.9996 19.0001C14.6314 19.0001 16.1745 18.6285 17.5507 17.9655L15.7571 16.1719C14.9668 16.695 14.0185 17.0003 12.9999 17.0003C10.2385 17.0003 7.99989 14.7618 7.99989 12.0003C7.99989 10.9817 8.3052 10.0334 8.82835 9.24312L6.69098 7.10574ZM10.292 10.7068C10.1046 11.0984 9.99989 11.5368 9.99989 12.0003C9.99989 13.6572 11.343 15.0003 12.9999 15.0003C13.4634 15.0003 13.9018 14.8956 14.2934 14.7082L10.292 10.7068ZM13 5.00003C12.4234 5.00003 11.8583 5.04642 11.3081 5.13548L10.321 5.29527L10.0014 3.32097L10.9885 3.16117C11.644 3.05508 12.3159 3.00003 13 3.00003C18.5786 3.00003 23.3012 6.65367 24.9104 11.696L25.0074 12L24.9104 12.3041C24.4968 13.5999 23.878 14.8034 23.0926 15.8763L22.5019 16.6833L20.8881 15.5019L21.4788 14.695C22.0769 13.8778 22.5595 12.9715 22.9028 12C21.4612 7.92082 17.5704 5.00003 13 5.00003ZM13.5132 6.92636L14.4691 7.21985C16.0499 7.70515 17.2953 8.95049 17.7806 10.5313L18.0741 11.4873L16.1621 12.0742L15.8687 11.1183C15.578 10.1715 14.829 9.42243 13.8822 9.13178L12.9262 8.8383L13.5132 6.92636Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"browse-off",ref:v},a)));p.displayName="BrowseOffIcon";const s=p},23436:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23ZM7.49985 10.5858L10.4999 13.5858L16.4999 7.58578L17.9141 8.99999L10.4999 16.4142L6.08564 12L7.49985 10.5858Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"check-circle-filled",ref:v},a)));p.displayName="CheckCircleFilledIcon";const s=p},46608:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M17.5001 8.08582L12.0002 13.5858L6.50015 8.08582L5.08594 9.50003L12.0002 16.4142L18.9144 9.50003L17.5001 8.08582Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"chevron-down",ref:v},a)));p.displayName="ChevronDownIcon";const s=p},58360:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23ZM8.81753 7.40346L11.9999 10.5858L15.1815 7.40414L16.5957 8.81835L13.4141 12L16.5957 15.1816L15.1815 16.5958L11.9999 13.4142L8.81753 16.5965L7.40332 15.1823L10.5856 12L7.40332 8.81767L8.81753 7.40346Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"close-circle-filled",ref:v},a)));p.displayName="CloseCircleFilledIcon";const s=p},27377:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M7.04996 5.63599L11.9997 10.5857L16.9494 5.63599L18.3637 7.0502L13.4139 11.9999L18.3637 16.9497L16.9494 18.3639L11.9997 13.4142L7.04996 18.3639L5.63574 16.9497L10.5855 11.9999L5.63574 7.0502L7.04996 5.63599Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"close",ref:v},a)));p.displayName="CloseIcon";const s=p},50397:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23ZM10.996 8.50002V6.49611H12.9999V8.50002H10.996ZM12.9999 10L12.9999 17.5H10.9999V10L12.9999 10Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"info-circle-filled",ref:v},a)));p.displayName="InfoCircleFilledIcon";const s=p},60333:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 2.25C6.61556 2.25 2.25 6.61556 2.25 12C2.25 17.3844 6.61556 21.75 12 21.75V19.3125C7.96142 19.3125 4.6875 16.0386 4.6875 12C4.6875 7.96142 7.96142 4.6875 12 4.6875C16.0386 4.6875 19.3125 7.96142 19.3125 12H21.75C21.75 6.61556 17.3844 2.25 12 2.25Z",fill:"currentColor",fillOpacity:.9}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"loading",ref:v},a)));p.displayName="LoadingIcon";const s=p},36106:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M15.0962 5.90381C12.5578 3.3654 8.44221 3.3654 5.90381 5.90381C3.3654 8.44221 3.3654 12.5578 5.90381 15.0962C8.44221 17.6346 12.5578 17.6346 15.0962 15.0962C17.6346 12.5578 17.6346 8.44221 15.0962 5.90381ZM4.48959 4.48959C7.80905 1.17014 13.191 1.17014 16.5104 4.48959C19.5906 7.56983 19.8126 12.4259 17.1764 15.7621L22.5208 21.1066L21.1066 22.5208L15.7621 17.1764C12.4259 19.8126 7.56983 19.5906 4.48959 16.5104C1.17014 13.191 1.17014 7.80905 4.48959 4.48959Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"search",ref:v},a)));p.displayName="SearchIcon";const s=p},65466:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 2.58569L17.9142 8.49991L16.5 9.91412L13 6.41412L13 15.9999H11L11 6.41412L7.5 9.91412L6.08579 8.49991L12 2.58569ZM4.5 13.9999V18.9999H19.5V13.9999H21.5V20.9999H2.5V13.9999H4.5Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"upload",ref:v},a)));p.displayName="UploadIcon";const s=p},21925:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",K({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 1C18.0751 1 23 5.92487 23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1ZM11.0001 14H13.0001V6.49998H11.0001V14ZM13.004 15.5H11.0001V17.5039H13.004V15.5Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,K({svg:(0,n.createElement)(r),type:"warn-circle-filled",ref:v},a)));p.displayName="WarnCircleFilledIcon";const s=p},5629:function(x,t,e){"use strict";e.r(t),e.d(t,{AddIcon:function(){return r.Z},BrowseIcon:function(){return s.Z},BrowseOffIcon:function(){return p.Z},CheckCircleFilledIcon:function(){return a.Z},ChevronDownIcon:function(){return v.Z},CloseCircleFilledIcon:function(){return I.Z},CloseIcon:function(){return h.Z},IconContext:function(){return m.Z},InfoCircleFilledIcon:function(){return u.Z},LoadingIcon:function(){return c.Z},SearchIcon:function(){return d.Z},UploadIcon:function(){return l.Z},WarnCircleFilledIcon:function(){return f.Z},default:function(){return i}});var n=e(37907),m=e(31136),r=e(46874),p=e(85569),s=e(1824),a=e(23436),v=e(46608),I=e(58360),h=e(27377),u=e(50397),c=e(60333),d=e(36106),l=e(65466),f=e(21925);const i=n.Z},34028:function(x,t,e){"use strict";e.d(t,{J:function(){return n}});function n(){return!!(typeof window!="undefined"&&window.document&&window.document.createElement)}},78831:function(x,t,e){"use strict";e.d(t,{D:function(){return n}});function n(m,r){let p=null;const s=function(){for(var a=arguments.length,v=new Array(a),I=0;I<a;I++)v[I]=arguments[I];p&&clearTimeout(p),p=setTimeout(()=>{m.apply(this,v),p=null},r)};return s.cancel=()=>{p&&(clearTimeout(p),p=null)},s}},80703:function(x,t,e){"use strict";e.d(t,{HD:function(){return s},Kn:function(){return a},Qr:function(){return v},hj:function(){return I},kJ:function(){return p},mf:function(){return m},o8:function(){return r}});const n=Object.prototype.toString;function m(h){return n.call(h)==="[object Function]"}function r(h){return h===void 0}function p(h){return n.call(h)==="[object Array]"}function s(h){return n.call(h)==="[object String]"}const a=h=>n.call(h)==="[object Object]",v=h=>{if(!a(h))return!0;for(const u in h)if(Object.prototype.hasOwnProperty.call(h,u))return!1;return!0},I=h=>n.call(h)==="[object Number]"&&!Number.isNaN(h)},12598:function(x,t,e){"use strict";e.d(t,{C:function(){return n}});function n(m,r){const p=Object.assign({},m);return Array.isArray(r)&&r.forEach(s=>{delete p[s]}),p}},6890:function(x,t,e){"use strict";e.d(t,{P:function(){return m}});var n=e(78831);function m(r,p){let s=null;const a=(0,n.D)(r,p),v=function(){for(var I=arguments.length,h=new Array(I),u=0;u<I;u++)h[u]=arguments[u];s===null?s=Date.now():Date.now()-s>=p&&(s=Date.now(),a.cancel()),a(...h)};return v.cancel=a.cancel,v}},92266:function(x,t,e){"use strict";e.d(t,{C:function(){return p},Z:function(){return s}});var n=e(53360),m=e(7829),r=e(62222);const p=(0,n.forwardRef)((a,v)=>{const w=a,{prefixCls:I,className:h,style:u,checked:c,disabled:d,defaultChecked:l=!1,type:f="checkbox",title:i,onChange:o,_getCheckedValue:R}=w,E=Ue(w,["prefixCls","className","style","checked","disabled","defaultChecked","type","title","onChange","_getCheckedValue"]),[T,g]=(0,r.R)(l,{value:c});(0,n.useEffect)(()=>{R==null||R(T)},[T]);const M=(0,m.default)(I,h,{[`${I}-checked`]:T,[`${I}-disabled`]:d}),B=Y=>{d||("checked"in a||g(Y.target.checked),o==null||o({target:Pe(K({},a),{checked:Y.target.checked}),event:Y}))};return n.createElement("span",{className:M,title:i,style:u},n.createElement("input",Pe(K({},E),{className:`${I}-input`,ref:v,onChange:B,disabled:d,checked:T,type:f})),n.createElement("span",{className:`${I}-inner`}))});p.displayName="BaseCheckbox";const s=p},40549:function(x,t,e){"use strict";e.d(t,{Z:function(){return v}});var n=e(53360),m=e(7829),r=e(64508),p=e(80703),s=e(57577);const a=(0,n.forwardRef)((I,h)=>{const u=(0,n.useContext)(s.E),g=I,{children:c,name:d,prefixCls:l}=g,f=Ue(g,["children","name","prefixCls"]),[i,o]=(0,r.Y)(f),R=(0,n.isValidElement)(c);(0,n.useImperativeHandle)(h,()=>({toggle:o}));const E=`${l||u.prefixCls}${d?`-${d}`:""}`,T=(0,m.default)([`${E}-motion`],{[`${E}-motion-${i.status}`]:i.status});return(0,p.mf)(c)?i.isMounted?c(Pe(K({},i),{className:T,toggle:o})):null:R?i.isMounted?(0,n.cloneElement)(c,{className:(0,m.default)(c.props.className,T)}):null:c});a.displayName="CSSMotion";const v=a},4814:function(x,t,e){"use strict";e.d(t,{sQ:function(){return s},t4:function(){return u},x1:function(){return v}});var n=e(37797),m=e(80703),r=e(53360),p=e(11607);const s=function(){for(var c=arguments.length,d=new Array(c),l=0;l<c;l++)d[l]=arguments[l];const f=d.filter(Boolean);return f.length<=1?f[0]:i=>{d.forEach(o=>{a(o,i)})}},a=(c,d)=>{(0,m.mf)(c)?c(d):(0,m.Kn)(c)&&"current"in c&&(c.current=d)},v=function(){for(var c=arguments.length,d=new Array(c),l=0;l<c;l++)d[l]=arguments[l];return(0,n.D)(()=>s(...d),d,(f,i)=>f.length!==i.length||f.every((o,R)=>o!==i[R]))},I=c=>{var d,l;if(!c)return!1;const f=parseInt(r.version,10);if(h(c)&&f>=19)return!0;const i=(0,p.isMemo)(c)?c.type.type:c.type;return!(typeof i=="function"&&!((d=i.prototype)!=null&&d.render)&&i.$$typeof!==p.ForwardRef||typeof c=="function"&&!((l=c.prototype)!=null&&l.render)&&c.$$typeof!==p.ForwardRef)};function h(c){return(0,r.isValidElement)(c)&&!(0,p.isFragment)(c)}const u=c=>h(c)&&I(c)},21299:function(x,t,e){"use strict";e.d(t,{q:function(){return r}});var n=e(53360),m=e(11607);function r(p){let s=[];return n.Children.toArray(p).forEach(a=>{a!=null&&(Array.isArray(a)?s=s.concat(r(a)):(0,n.isValidElement)(a)&&(0,m.isFragment)(a)&&a.props?s=s.concat(r(a.props.children)):s.push(a))}),s}},69203:function(x,t,e){"use strict";e.d(t,{b:function(){return o}});var n=e(27833),m=e(53360),r=e(7829),p=e(7657),s=e(23436),a=e(50397),v=e(58360),I=e(21925),h=e(27377),u=e(40549),c=e(57577);const d={type:"info",showIcon:!0},l={success:s.Z,info:a.Z,error:v.Z,warning:I.Z},f=(0,m.forwardRef)((E,T)=>{const g=(0,n.c)(38),{prefixCls:M,componentConfig:B}=(0,m.useContext)(c.E),{className:w,style:Y,title:k,description:ne,type:N,closable:O,showIcon:z,action:$,icon:J,onClose:V}=(0,p.S)(E,d,B==null?void 0:B.Alert),j=(0,m.useRef)(null);let te;g[0]!==J||g[1]!==N?(te=()=>(0,m.isValidElement)(J)?J:N?(0,m.createElement)(l[N]):null,g[0]=J,g[1]=N,g[2]=te):te=g[2];const P=te,S=`${M}-alert`,W=`${M}-alert-${N}`;let X;g[3]!==w||g[4]!==S||g[5]!==W?(X=(0,r.default)(S,W,w),g[3]=w,g[4]=S,g[5]=W,g[6]=X):X=g[6];const A=X;let xe;g[7]!==V?(xe=ge=>{var be;(be=j.current)==null||be.toggle(),V==null||V(ge)},g[7]=V,g[8]=xe):xe=g[8];const F=xe;let ie;g[9]!==M||g[10]!==P||g[11]!==z?(ie=z&&m.createElement("div",{className:`${M}-alert-icon`},P()),g[9]=M,g[10]=P,g[11]=z,g[12]=ie):ie=g[12];const pe=`${M}-alert-content`;let D;g[13]!==M||g[14]!==k?(D=!!k&&m.createElement("div",{className:`${M}-alert-title`},k),g[13]=M,g[14]=k,g[15]=D):D=g[15];const L=`${M}-alert-description`;let q;g[16]!==ne||g[17]!==L?(q=m.createElement("div",{className:L},ne),g[16]=ne,g[17]=L,g[18]=q):q=g[18];let b;g[19]!==pe||g[20]!==D||g[21]!==q?(b=m.createElement("div",{className:pe},D,q),g[19]=pe,g[20]=D,g[21]=q,g[22]=b):b=g[22];let ve;g[23]!==$||g[24]!==M?(ve=$&&m.createElement("div",{className:`${M}-alert-action`},$),g[23]=$,g[24]=M,g[25]=ve):ve=g[25];let ye;g[26]!==O||g[27]!==F||g[28]!==M?(ye=O&&m.createElement("button",{type:"button",className:`${M}-alert-close`,onClick:F},m.createElement(h.Z,null)),g[26]=O,g[27]=F,g[28]=M,g[29]=ye):ye=g[29];let _;return g[30]!==A||g[31]!==T||g[32]!==Y||g[33]!==b||g[34]!==ve||g[35]!==ye||g[36]!==ie?(_=m.createElement(u.Z,{ref:j,timeout:200,name:"alert",unmountOnExit:!0,initialEntered:!0},m.createElement("div",{role:"alert",className:A,style:Y,ref:T},ie,b,ve,ye)),g[30]=A,g[31]=T,g[32]=Y,g[33]=b,g[34]=ve,g[35]=ye,g[36]=ie,g[37]=_):_=g[37],_});f.displayName="Alert";const o=f,R=null},60884:function(x,t,e){"use strict";e.d(t,{z:function(){return h}});var n=e(53360),m=e(7829),r=e(60333),p=e(7657),s=e(57577);const a={type:"default",variant:"default",htmlType:"button"},v=(0,n.forwardRef)((c,d)=>{const{prefixCls:l,size:f="md",componentConfig:i}=(0,n.useContext)(s.E),P=(0,p.S)(c,a,i==null?void 0:i.Button),{children:R,type:E,size:T=f,htmlType:g,status:M,loading:B,disabled:w,variant:Y,icon:k,href:ne,target:N,onClick:O,anchorProps:z={}}=P,$=Ue(P,["children","type","size","htmlType","status","loading","disabled","variant","icon","href","target","onClick","anchorProps"]),J=B?n.createElement(r.Z,{spin:B}):k,V=ne?"link":E,j=(0,m.default)(`${l}-btn`,`${l}-btn-${V}`,{[`${l}-btn-size-${T}`]:T,[`${l}-btn-status-${M}`]:!!M,[`${l}-btn-variant-${Y}`]:Y,[`${l}-btn-loading`]:B,[`${l}-btn-disabled`]:w}),te=S=>{if(B||w)return void S.preventDefault();O==null||O(S)};return ne?n.createElement("a",Pe(K({},z),{href:ne,target:N,className:j,onClick:te,ref:d}),J,n.createElement("span",null,R)):n.createElement("button",Pe(K({},$),{type:g,className:j,onClick:te,ref:d}),J,n.createElement("span",null,R))});v.displayName="Button";const h=v,u=null},67824:function(x,t,e){"use strict";e.d(t,{Z:function(){return d}});var n=e(53360),m=e(7829),r=e(7657),p=e(45844),s=e(80703),a=e(92266),v=e(4814),I=e(57577),h=e(81372);const u={defaultChecked:!1,indeterminate:!1},c=(0,n.forwardRef)((l,f)=>{const{prefixCls:i,componentConfig:o}=(0,n.useContext)(I.E),R=(0,n.useContext)(h.w),V=(0,r.S)(l,u,o==null?void 0:o.Checkbox),{children:E,style:T,className:g,indeterminate:M}=V,B=Ue(V,["children","style","className","indeterminate"]),[w,Y]=(0,n.useState)(!1),k="disabled"in B?B.disabled:R.disabled,ne=(0,p.D)(B.value),N=(0,n.useRef)(null);(0,n.useEffect)(()=>{var j;(j=R.registerValue)==null||j.call(R,B.value)},[R,B.value]),(0,n.useEffect)(()=>{if(B.value!==ne.current){var j,te;(j=R.unregisterValue)==null||j.call(R,ne.current),(te=R.registerValue)==null||te.call(R,B.value)}return()=>{var P;return(P=R.unregisterValue)==null?void 0:P.call(R,B.value)}},[R,B.value]),(0,n.useEffect)(()=>{N.current&&(N.current.indeterminate=M)},[M]);const O=K({},B);(0,s.Qr)(R)||(O.onChange=function(){for(var j=arguments.length,te=new Array(j),P=0;P<j;P++)te[P]=arguments[P];var S,W;(S=B.onChange)==null||S.call(B,...te),(W=R.toggleOption)==null||W.call(R,B.value)},O.name=R.name,O.checked=R.value.includes(B.value));const z=(0,m.default)(`${i}-checkbox-wrapper`,{[`${i}-checkbox-wrapper-checked`]:O.checked,[`${i}-checkbox-wrapper-disabled`]:k},g),$=j=>{if((0,s.mf)(E)){var te;j.preventDefault(),(te=N.current)==null||te.click()}},J=()=>(0,s.o8)(E)?null:(0,s.mf)(E)?E({checked:"checked"in O?!!O.checked:w}):n.createElement("span",{className:`${i}-checkbox-label`},E);return n.createElement("label",{className:z,onClick:$},n.createElement(a.C,Pe(K({},O),{type:"checkbox",ref:(0,v.sQ)(f,N),disabled:k,prefixCls:`${i}-checkbox`,className:(0,m.default)({[`${i}-checkbox-indeterminate`]:M}),style:Pe(K({},T),{display:(0,s.mf)(E)?"none":void 0}),_getCheckedValue:Y})),J())});c.displayName="Checkbox";const d=c},56104:function(x,t,e){"use strict";e.d(t,{Z:function(){return u}});var n=e(53360),m=e(7829),r=e(7657),p=e(80703),s=e(57577),a=e(81372),v=e(67824);const I={},h=(0,n.forwardRef)((c,d)=>{const{prefixCls:l,componentConfig:f}=(0,n.useContext)(s.E),i=(0,n.useId)(),W=(0,r.S)(c,I,f==null?void 0:f.CheckboxGroup),{defaultValue:o,children:R,options:E,className:T,style:g,disabled:M,name:B=i,onChange:w,renderOption:Y}=W,k=Ue(W,["defaultValue","children","options","className","style","disabled","name","onChange","renderOption"]),[ne,N]=(0,n.useState)(k.value||o||[]),[O,z]=(0,n.useState)([]),$=(0,n.useRef)([]);(0,n.useEffect)(()=>{$.current=O},[O]),(0,n.useEffect)(()=>{"value"in k&&N(k.value||[])},[k.value]);const J=(0,n.useCallback)(X=>{z(A=>[...A,X])},[]),V=(0,n.useCallback)(X=>{z(A=>A.filter(xe=>xe!==X))},[]),j=(0,n.useMemo)(()=>E==null?void 0:E.map(X=>(0,p.HD)(X)||(0,p.hj)(X)?{label:X,value:X}:X),[E]),te=(0,n.useCallback)(X=>{const A=[...ne],xe=ne.indexOf(X);xe===-1?A.push(X):A.splice(xe,1),"value"in k||N(A);const F=A.filter(ie=>$.current.includes(ie));w==null||w(F)},[ne,w]);let P=R;if((0,p.kJ)(j)&&j.length>0){const X=(0,p.mf)(Y);P=j.map(A=>{const xe=ne.includes(A.value),F=X?()=>Y(Pe(K({},A),{checked:xe})):A.label;return n.createElement(v.Z,{key:`checkbox-group-options-${A.value}`,className:A.className,style:A.style,disabled:"disabled"in A?A.disabled:M,value:A.value,checked:xe,id:A.id,title:A.title,onChange:A.onChange},F)})}const S=(0,n.useMemo)(()=>({name:B,value:ne,disabled:M,toggleOption:te,registerValue:J,unregisterValue:V}),[B,ne,M,te,J,V]);return n.createElement("div",{className:(0,m.default)(`${l}-checkbox-group`,T),style:g,ref:d},n.createElement(a.w.Provider,{value:S},P))});h.displayName="CheckboxGroup";const u=h},81372:function(x,t,e){"use strict";e.d(t,{w:function(){return m}});var n=e(53360);const m=(0,n.createContext)({})},89946:function(x,t,e){"use strict";e.r(t),e.d(t,{Checkbox:function(){return v},CheckboxGroup:function(){return I},default:function(){return h}});var n=e(67824),m=e(56104),r=e(558),p=e.n(r),s={};for(var a in r)["default","Checkbox","CheckboxGroup"].indexOf(a)<0&&(s[a]=function(u){return r[u]}.bind(0,a));e.d(t,s);const v=n.Z;v.Group=m.Z;const I=v.Group,h=v},558:function(){},57577:function(x,t,e){"use strict";e.d(t,{$:function(){return m},E:function(){return r}});var n=e(53360);const m={componentConfig:{},prefixCls:"sqi",iconPrefix:"sqi"},r=(0,n.createContext)(m)},83405:function(x,t,e){"use strict";e.d(t,{i:function(){return I}});var n=e(27833),m=e(53360),r=e(12598),p=e(7657),s=e(31136),a=e(57577);function v(h){const u=(0,n.c)(11),c=(0,p.S)(h,a.$),{iconPrefix:d,children:l}=c;let f;u[0]!==c?(f=(0,r.C)(c,["children","iconPrefix"]),u[0]=c,u[1]=f):f=u[1];const i=f,o=d?s.Z.Provider:m.Fragment;let R;u[2]!==d?(R={prefixCls:d},u[2]=d,u[3]=R):R=u[3];let E;u[4]!==o||u[5]!==l||u[6]!==R?(E=m.createElement(o,{value:R},l),u[4]=o,u[5]=l,u[6]=R,u[7]=E):E=u[7];let T;return u[8]!==i||u[9]!==E?(T=m.createElement(a.E.Provider,{value:i},E),u[8]=i,u[9]=E,u[10]=T):T=u[10],T}v.displayName="ConfigProvider";const I=v},48380:function(x,t,e){"use strict";e.d(t,{i:function(){return I}});var n=e(53360),m=e(7829),r=e(7657),p=e(57577);const s={direction:"horizontal",align:"center"},a=(0,n.forwardRef)((u,c)=>{const{prefixCls:d,componentConfig:l}=(0,n.useContext)(p.E),f=(0,r.S)(u,s,l==null?void 0:l.Divider),{direction:i,align:o,dashed:R,className:E,children:T,text:g,style:M}=f,B=T||g,w=i!=="vertical"&&!!B,Y=(0,m.default)(`${d}-divider`,{[`${d}-divider-${i}`]:i,[`${d}-divider-with-text`]:w,[`${d}-divider-with-text-${o}`]:w,[`${d}-divider-dashed`]:!!R,className:E});return n.createElement("div",{className:Y,style:M,ref:c},w&&n.createElement("span",{className:`${d}-divider-inner-text`},B))});a.displayName="Divider";const I=a,h=null},17599:function(x,t,e){"use strict";e.d(t,{J:function(){return ne},X:function(){return k}});var n=e(53360),m=e(7829),r=e(7657),p=e(80703),s=e(57577);const a=["xxl","xl","lg","md","sm","xs"],v={xs:"(max-width: 575px)",sm:"(min-width: 576px)",md:"(min-width: 768px)",lg:"(min-width: 992px)",xl:"(min-width: 1200px)",xxl:"(min-width: 1600px)"},I=Object.keys(v),h=new Map;let u=-1,c={};const l={handlers:{},dispatch(N){return c=N,h.forEach(O=>{O(c)}),h.size>=1},subscribe(N){return h.size||this.register(),u+=1,h.set(u,N),N(c),u},unsubscribe(N){h.delete(N),h.size||this.unregister()},register(){I.forEach(N=>{const O=J=>{let{matches:V}=J;this.dispatch(Pe(K({},c),{[N]:V}))},z=v[N],$=window.matchMedia(z);$.addListener(O),this.handlers[z]={mql:$,listener:O},O($)})},unregister(){I.forEach(N=>{const O=v[N],z=this.handlers[O];z==null||z.mql.removeListener(z==null?void 0:z.listener)}),h.clear()}},i=(0,n.createContext)({}),o={gutter:0,align:"start",justify:"start",wrap:!0},R=(0,n.forwardRef)((N,O)=>{const{prefixCls:z,componentConfig:$}=(0,n.useContext)(s.E),_=(0,r.S)(N,o,$==null?void 0:$.Row),{align:J,justify:V,gutter:j,className:te,wrap:P,children:S,style:W}=_,X=Ue(_,["align","justify","gutter","className","wrap","children","style"]),[A,xe]=(0,n.useState)({xs:!1,sm:!1,md:!1,lg:!1,xl:!1,xxl:!1});(0,n.useEffect)(()=>{const ge=l.subscribe(be=>{((0,p.Kn)(j)||(0,p.kJ)(j)&&((0,p.Kn)(j[0])||(0,p.Kn)(j[1])))&&xe(be)});return()=>l.unsubscribe(ge)},[j]);const F=ie();function ie(){const ge=[void 0,void 0];return((0,p.kJ)(j)?j:[j,void 0]).forEach((C,G)=>{if((0,p.Kn)(C))for(let y=0;y<a.length;y++){const oe=a[y];if(A[oe]&&C[oe]!==void 0){ge[G]=C[oe];break}}else ge[G]=C}),ge}const pe=(0,m.default)(`${z}-row`,{[`${z}-row-nowrap`]:P===!1,[`${z}-row-align-${J}`]:J,[`${z}-row-justify-${V}`]:V},te),[D,L]=F,q=(0,n.useMemo)(()=>({gutter:[D,L],wrap:P}),[D,L,P]),b={},ve=(0,p.hj)(D)&&D!==0,ye=(0,p.hj)(L)&&L!==0;if(ve||ye){const ge=-D/2,be=-L/2;ge&&(b.marginLeft=ge,b.marginRight=ge),be&&(b.marginTop=be,b.marginBottom=be)}return n.createElement(i.Provider,{value:q},n.createElement("div",Pe(K({},X),{ref:O,className:pe,style:K(K({},W),b)}),S))});R.displayName="Row";const E=R,T={offset:0};function g(N){return(0,p.hj)(N)?`${N} ${N} auto`:/^\d+(\.\d+)?(px|em|rem|%)$/.test(N)?`0 0 ${N}`:N}const M=["xs","sm","md","lg","xl","xxl"],B=(N,O)=>{let z={};return M.forEach($=>{const J=N[$];if(!J)return;let V={};(0,p.hj)(J)?V.span=J:(0,p.Kn)(J)&&(V=J),z=Pe(K({},z),{[`${O}-col-${$}-${V.span}`]:(0,p.hj)(V.span),[`${O}-col-${$}-order-${V.order}`]:V.order,[`${O}-col-${$}-offset-${V.offset}`]:V.offset})}),z},w=(0,n.forwardRef)((N,O)=>{const{componentConfig:z,prefixCls:$}=(0,n.useContext)(s.E),{gutter:J}=(0,n.useContext)(i),_=(0,r.S)(N,T,z==null?void 0:z.Col),{span:V,offset:j,children:te,className:P,style:S,flex:W,order:X,xs:A,sm:xe,md:F,lg:ie,xl:pe,xxl:D}=_,L=Ue(_,["span","offset","children","className","style","flex","order","xs","sm","md","lg","xl","xxl"]),q=B({xs:A,sm:xe,md:F,lg:ie,xl:pe,xxl:D},$),b=(0,m.default)(`${$}-col`,{[`${$}-col-${V}`]:(0,p.hj)(V),[`${$}-col-offset-${j}`]:j,[`${$}-col-order-${X}`]:X},q,P),ve={};if(J){const ge=J[0]?J[0]/2:0,be=J[1]?J[1]/2:0;ge&&(ve.paddingLeft=ge,ve.paddingRight=ge),be&&(ve.paddingTop=be,ve.paddingBottom=be)}const ye={};return W&&(ye.flex=g(W)),n.createElement("div",Pe(K({ref:O},L),{className:b,style:K(K(K({},S),ye),ve)}),te)});w.displayName="Col";const Y=w,k=E,ne=Y},45990:function(x,t,e){"use strict";e.r(t),e.d(t,{Alert:function(){return n.b},Button:function(){return m.z},Col:function(){return v.J},ConfigProvider:function(){return s.i},Divider:function(){return a.i},Input:function(){return I.I},Row:function(){return v.X},Space:function(){return u.T},Switch:function(){return c.r}});var n=e(69203),m=e(60884),r=e(89946),l={};for(var p in r)["default","Alert","Button"].indexOf(p)<0&&(l[p]=function(f){return r[f]}.bind(0,p));e.d(t,l);var s=e(83405),a=e(48380),v=e(17599),I=e(38312),h=e(37663),l={};for(var p in h)["default","Alert","Button","Checkbox","CheckboxGroup","ConfigProvider","Divider","Col","Row","Input"].indexOf(p)<0&&(l[p]=function(i){return h[i]}.bind(0,p));e.d(t,l);var u=e(92595),c=e(9090),d=e(36112),l={};for(var p in d)["default","Alert","Button","Checkbox","CheckboxGroup","ConfigProvider","Divider","Col","Row","Input","Radio","RadioButton","RadioGroup","Space","Switch"].indexOf(p)<0&&(l[p]=function(i){return d[i]}.bind(0,p));e.d(t,l)},38312:function(x,t,e){"use strict";e.d(t,{I:function(){return f}});var n=e(53360),m=e(7829),r=e(7657),p=e(62222),s=e(80703),a=e(58360),v=e(85569),I=e(1824),h=e(57577);const u={type:"text",size:"md",align:"left",visibilityToggle:!0};function c(o,R,E){let T;return T=o===null||(0,s.o8)(o)||(0,s.HD)(o)?o||"":String(o),(0,s.hj)(R)&&!E?T.slice(0,R):T}const d=(0,n.forwardRef)((o,R)=>{const{prefixCls:E,componentConfig:T}=(0,n.useContext)(h.E),Ke=(0,r.S)(o,u,T==null?void 0:T.Input),{size:g,status:M,align:B,disabled:w,allowClear:Y,placeholder:k,variant:ne="outline",addonBefore:N,addonAfter:O,prefix:z,suffix:$,value:J,defaultValue:V,type:j,className:te,style:P,readOnly:S,visibilityToggle:W,maxLength:X,tips:A,onFocus:xe,onBlur:F,onChange:ie}=Ke,pe=Ue(Ke,["size","status","align","disabled","allowClear","placeholder","variant","addonBefore","addonAfter","prefix","suffix","value","defaultValue","type","className","style","readOnly","visibilityToggle","maxLength","tips","onFocus","onBlur","onChange"]),D=(0,n.useRef)(null),L=(0,n.useRef)(null);(0,n.useImperativeHandle)(R,()=>({currentElement:D.current,inputElement:L.current,focus:()=>{var de;return(de=L.current)==null?void 0:de.focus()},blur:()=>{var de;return(de=L.current)==null?void 0:de.blur()},select:()=>{var de;return(de=L.current)==null?void 0:de.select()}}));const[q,b]=(0,n.useState)(!1),ve=de=>{w||S||(b(!0),xe==null||xe(de))},ye=de=>{w||S||(b(!1),F==null||F(de))},_=(0,s.hj)(X)?X:X==null?void 0:X.length,ge=(0,s.hj)(X)?!1:X==null?void 0:X.errorOnly,be=(0,s.hj)(X)?!0:(X==null?void 0:X.showLimit)!==!1,[C,G]=(0,p.R)(V,{value:J}),y=c(C,_,ge),oe=(0,s.hj)(_)?y.length>_:!1,re=de=>{const{value:he}=de.target;G(he),ie==null||ie(he,de)},ue=()=>{var de;w||(de=L.current)==null||de.focus()},ce=(0,m.default)(`${E}-input`,{[`${E}-input-variant-${ne}`]:ne,[`${E}-input-size-${g}`]:g,[`${E}-input-disabled`]:w,[`${E}-input-align-${B}`]:B,[`${E}-input-status-${M}`]:M,[`${E}-input-focus`]:q,[`${E}-input-limit-length-error`]:oe},te),Q=(0,m.default)(`${E}-input-real`),Ie=Y&&y&&!w,Z=n.createElement(a.Z,null),me=de=>{de.stopPropagation(),G(""),ie==null||ie("",de)},H=Ie&&n.createElement("button",{type:"button",tabIndex:-1,className:(0,m.default)(`${E}-input-suffix`,`${E}-input-clear`),onClick:me},Z),U=(0,s.Kn)(W)&&!(0,s.o8)(W.visible),[De,Be]=(0,n.useState)(j),ae=(0,s.Kn)(W)?W.visible:W;(0,n.useEffect)(()=>{Be(U?ae?"text":"password":j)},[j,U,ae]);const Ee=()=>{if(w)return;const de=De==="password"?"text":"password";if(Be(de),U){var he;(he=W.onVisibleChange)==null||he.call(W,de==="text")}},ee=j==="password",se=(0,n.useMemo)(()=>ee?(0,s.Kn)(W)&&(0,s.mf)(W.renderIcon)?W.renderIcon(De==="text"):De==="password"?n.createElement(v.Z,null):De==="text"?n.createElement(I.Z,null):null:$,[ee,De,W,$]),le=(0,n.useMemo)(()=>function(de){let{children:he}=de;const Me=N||O;let Le=he;return Me&&(Le=n.createElement("div",{ref:D,className:`${E}-input-group`},Le)),A&&(Le=n.createElement("div",{ref:D,className:`${E}-input-group-extra`},Le)),Le},[E,N,O,A]),we=z&&n.createElement("span",{className:`${E}-input-prefix`},z),Ce=se&&n.createElement("span",{role:"button",tabIndex:-1,className:(0,m.default)(`${E}-input-suffix`,{[`${E}-input-suffix-password`]:ee}),onClick:Ee,onMouseDown:de=>de.preventDefault(),onMouseUp:de=>de.preventDefault()},se),Se=(0,s.hj)(_)&&be&&n.createElement("span",{className:`${E}-input-limit-length-text`},y.length,"/",_),$e=A&&n.createElement("div",{className:(0,m.default)(`${E}-input-tips`,{[`${E}-input-tips-status-${M}`]:M})},A),We=n.createElement("span",{role:"group",ref:N||O?void 0:D,className:ce,style:P,onClick:ue},we,n.createElement("input",Pe(K({ref:L},pe),{type:De,value:y,readOnly:S,className:Q,placeholder:k,disabled:w,onChange:re,onFocus:ve,onBlur:ye})),H,Ce,Se),Oe=N&&n.createElement("span",{className:(0,m.default)(`${E}-input-group-addon`)},N),je=O&&n.createElement("span",{className:(0,m.default)(`${E}-input-group-addon`)},O);return n.createElement(le,null,Oe,We,je,$e)});d.displayName="Input";const f=d,i=null},74052:function(x,t,e){"use strict";e.d(t,{Z:function(){return c}});var n=e(53360),m=e(7829),r=e(7657),p=e(80703),s=e(92266),a=e(4814),v=e(57577),I=e(83595);const h={defaultChecked:!1},u=(0,n.forwardRef)((d,l)=>{const{prefixCls:f,componentConfig:i}=(0,n.useContext)(v.E),o=(0,n.useContext)(I.Z),j=(0,r.S)(d,h,i==null?void 0:i.Radio),{_IS_BUTTON_:R,value:E,children:T,style:g}=j,M=Ue(j,["_IS_BUTTON_","value","children","style"]),B=te=>{var P,S;(P=M.onChange)==null||P.call(M,te),o==null||(S=o.onChange)==null||S.call(o,te)},w=K({},M);let Y="md";if(!(0,p.Qr)(o)){w.name=o.name,w.onChange=B,w.checked=E===o.value;var k;w.disabled=(k=w.disabled)!=null?k:o.disabled,Y=o.size?o.size:Y}const[ne,N]=(0,n.useState)(!1),O=R?`${f}-radio-button`:`${f}-radio`,z=(0,m.default)(`${O}-wrapper`,{[`${O}-wrapper-disabled`]:w.disabled,[`${O}-wrapper-checked`]:w.checked,[`${O}-wrapper-size-${Y}`]:Y,[`${O}-wrapper-filled`]:o.buttonVariant==="filled"}),$=()=>(0,p.o8)(T)?null:(0,p.mf)(T)?T({checked:"checked"in w?!!w.checked:ne}):n.createElement("span",{className:`${O}-label`},T),J=(0,n.useRef)(null),V=te=>{if((0,p.mf)(T)){var P;te.preventDefault(),(P=J.current)==null||P.click()}};return n.createElement("label",{className:z,onClick:V},n.createElement(s.Z,Pe(K(K({},M),w),{ref:(0,a.sQ)(l,J),value:E,type:"radio",prefixCls:O,style:Pe(K({},g),{display:(0,p.mf)(T)?"none":void 0}),disabled:w.disabled,_getCheckedValue:N})),$())});u.displayName="Radio";const c=u},89312:function(x,t,e){"use strict";e.d(t,{Z:function(){return a}});var n=e(27833),m=e.n(n),r=e(53360),p=e(74052);const s=(0,r.forwardRef)((v,I)=>{const h=(0,n.c)(3);let u;return h[0]!==v||h[1]!==I?(u=r.createElement(p.Z,Pe(K({_IS_BUTTON_:!0},v),{ref:I})),h[0]=v,h[1]=I,h[2]=u):u=h[2],u});s.displayName="RadioButton";const a=s},59803:function(x,t,e){"use strict";e.d(t,{Z:function(){return d}});var n=e(53360),m=e(7829),r=e(7657),p=e(62222),s=e(80703),a=e(57577),v=e(83595),I=e(74052),h=e(89312);const u={disabled:!1,size:"md",appearance:"radio",buttonVariant:"outline"},c=(0,n.forwardRef)((l,f)=>{const{prefixCls:i,componentConfig:o}=(0,n.useContext)(a.E),R=(0,r.S)(l,u,o==null?void 0:o.RadioGroup),E=(0,n.useId)(),{className:T,style:g,name:M=E,value:B,defaultValue:w,children:Y,disabled:k,size:ne,buttonVariant:N,renderOption:O,onChange:z,appearance:$,options:J}=R,[V,j]=(0,p.R)(w,{value:B}),te=(0,n.useCallback)(X=>{const A=X.target.value;"value"in R||j(A),A!==V&&(z==null||z(X))},[R.value,V,z]);let P=Y;const S=$==="button"?h.Z:I.Z;if((0,s.kJ)(J)&&J.length>0){const X=(0,s.mf)(O);P=J.map(A=>{if((0,s.HD)(A)||(0,s.hj)(A)){const ie=V===A,pe=X?()=>O({label:A,value:A,checked:ie}):A;return n.createElement(S,{key:A.toString(),disabled:k,value:A,checked:ie},pe)}const xe=V===A.value,F=X?()=>O(Pe(K({},A),{checked:xe})):A.label;return n.createElement(S,{key:`radio-group-options-${A.value}`,className:A.className,style:A.style,disabled:A.disabled||k,value:A.value,checked:xe,id:A.id,title:A.title,onChange:A.onChange},F)})}const W=(0,n.useMemo)(()=>({name:M,value:V,disabled:k,size:ne,buttonVariant:N,onChange:te}),[M,V,k,ne,N,te]);return n.createElement("div",{ref:f,className:(0,m.default)(`${i}-radio-group`,T),style:g},n.createElement(v.Z.Provider,{value:W},P))});c.displayName="RadioGroup";const d=c},83595:function(x,t,e){"use strict";e.d(t,{Z:function(){return r}});var n=e(53360);const r=(0,n.createContext)({})},37663:function(x,t,e){"use strict";e.r(t),e.d(t,{Radio:function(){return I},RadioButton:function(){return u},RadioGroup:function(){return h},default:function(){return c}});var n=e(74052),m=e(89312),r=e(59803),p=e(63149),s=e.n(p),a={};for(var v in p)["default","Radio","RadioButton","RadioGroup"].indexOf(v)<0&&(a[v]=function(d){return p[d]}.bind(0,v));e.d(t,a);const I=n.Z;I.Group=r.Z,I.Button=m.Z;const h=I.Group,u=I.Button,c=I},63149:function(){},92595:function(x,t,e){"use strict";e.d(t,{T:function(){return c}});var n=e(53360),m=e(7829),r=e(80703),p=e(7657),s=e(21299),a=e(57577);const v={sm:8,md:16,lg:24},I={direction:"horizontal",align:"center",wrap:!1},h=(0,n.forwardRef)((l,f)=>{const{prefixCls:i,size:o="md",componentConfig:R}=(0,n.useContext)(a.E),V=(0,p.S)(l,I,R==null?void 0:R.Space),{className:T,children:g,size:M=o,direction:B="horizontal",align:w,split:Y,wrap:k=!1}=V,ne=Ue(V,["className","children","size","direction","align","split","wrap"]),N=(0,s.q)(g),O=B==="horizontal"&&w===void 0?"center":w,z=(0,m.default)(`${i}-space`,`${i}-space-direction-${B}`,{[`${i}-space-align-${O}`]:O,[`${i}-space-wrap`]:k},T),$=(0,n.useCallback)(j=>{const te=(0,r.kJ)(M)?M:[M,M],[P,S]=te.map(W=>(0,r.HD)(W)?v[W]:W||0);return k?{marginRight:P,marginBottom:S}:B==="vertical"?{marginBottom:S}:{marginRight:j?void 0:P}},[M,B,k]),J=N.map((j,te)=>{const P=te===N.length-1;return n.createElement(n.Fragment,{key:`space-item-${te.toString()}`},n.createElement("div",{className:"space-item",style:$(P)},j),!P&&Y&&n.createElement("span",{className:"sqi-space-item-split"},Y))});return n.createElement("div",Pe(K({className:z},ne),{ref:f}),J)});h.displayName="Space";const c=h,d=null},9090:function(x,t,e){"use strict";e.d(t,{r:function(){return u}});var n=e(53360),m=e(7829),r=e(7657),p=e(62222),s=e(60333),a=e(57577);const v={label:[],loading:!1,disabled:!1},I=(0,n.forwardRef)((d,l)=>{const{prefixCls:f,size:i="md",componentConfig:o}=(0,n.useContext)(a.E),j=(0,r.S)(d,v,o==null?void 0:o.Switch),{checked:R,defaultChecked:E,className:T,disabled:g,size:M=i,label:B,loading:w,loadingIcon:Y,onChange:k,onClick:ne}=j,N=Ue(j,["checked","defaultChecked","className","disabled","size","label","loading","loadingIcon","onChange","onClick"]),[O,z]=(0,p.R)(!1,{value:R,defaultValue:E});function $(te){if(g||w)return;const P=!O;z(P),k==null||k(P,te),ne==null||ne(P,te)}const J=(0,m.default)(`${f}-switch`,{[`${f}-switch-checked`]:O,[`${f}-switch-disabled`]:g,[`${f}-switch-loading`]:w,[`${f}-switch-${M}`]:M},T),V=Y||n.createElement(s.Z,{spin:!0});return n.createElement("button",Pe(K({},N),{type:"button",role:"switch","aria-checked":O,ref:l,className:J,disabled:g||w,onClick:$}),n.createElement("div",{className:`${f}-switch-handle`},w&&V),n.createElement("div",{className:`${f}-switch-content`},O?B[0]:B[1]))});I.displayName="Switch";const u=I,c=null},67171:function(x,t,e){"use strict";e.d(t,{Z:function(){return be}});var n=e(53360),m=e(7829),r=e(7657),p=e(62222),s=e(60164),a=e(6890),v=e(8240),I=e(21299);function h(C){return C instanceof HTMLElement||C instanceof SVGElement}function u(C){return C&&typeof C=="object"&&h(C.nativeElement)?C.nativeElement:h(C)?C:null}function c(C){if(C)return C.current&&typeof C.current=="object"&&"currentElement"in C.current?C.current.currentElement:C.current}function d(C){if(!(C&&(0,n.isValidElement)(C)))return null;if(parseInt(n.version,10)>=19){var y;return((y=C.props)==null?void 0:y.ref)||null}return C.ref}var l=e(4814);const f=(0,n.forwardRef)((C,G)=>{const{children:y,disabled:oe,throttleMs:re=100,onResize:ue}=C,ce=(0,n.isValidElement)(y),Q=ce?(0,I.q)(y):[],Ie=ce?d(y):null,Z=(0,n.useRef)(null),me=(0,l.x1)(Ie,Z),H=()=>c(Z);(0,n.useImperativeHandle)(G,()=>c(Z));const U=ue?(0,a.P)(ue,re):void 0;return(0,v.y)(H(),U,!oe),ce?(0,n.cloneElement)(y,{ref:me}):y});f.displayName="ResizeObserverComponent";const i=f;var o=e(27833),R=e(86752),E=e(34028),T=e(80703);const g=(0,E.J)();function M(C){return g?(0,T.HD)(C)?document.querySelector(C):(0,T.mf)(C)?C():C instanceof HTMLElement?C:document.body:null}const B=(0,n.forwardRef)((C,G)=>{const y=(0,o.c)(25),{getContainer:oe,prefixCls:re,children:ue,open:ce,rootStyle:Q}=C,Ie=ce===void 0?!0:ce,[Z,me]=(0,n.useState)(null),[H,U]=(0,n.useState)(null),De=H||document.body;let Be,ae;y[0]!==oe?(Be=()=>{const Oe=M(oe);U(Oe||null)},ae=[oe],y[0]=oe,y[1]=Be,y[2]=ae):(Be=y[1],ae=y[2]),(0,n.useEffect)(Be,ae);let Ee;y[3]!==Z||y[4]!==re||y[5]!==Q?(Ee=()=>{if(!g||Z)return null;const Oe=document.createElement("div");re&&(Oe.className=`${re}-portal-wrapper`),Q&&Object.assign(Oe.style,Q),Oe.setAttribute("data-portal","true"),me(Oe)},y[3]=Z,y[4]=re,y[5]=Q,y[6]=Ee):Ee=y[6];const ee=Ee;let se;y[7]!==ee||y[8]!==Ie?(se=()=>{g&&(Ie?ee():me(null))},y[7]=ee,y[8]=Ie,y[9]=se):se=y[9];let le;y[10]!==Ie?(le=[Ie],y[10]=Ie,y[11]=le):le=y[11],(0,s.L)(se,le);let we,Ce;y[12]!==Z?(we=()=>Z,Ce=[Z],y[12]=Z,y[13]=we,y[14]=Ce):(we=y[13],Ce=y[14]),n.useImperativeHandle(G,we,Ce);let Se;y[15]!==Z||y[16]!==De||y[17]!==Ie?(Se=()=>{if(!g||!Z)return;const Oe=()=>!Z.parentNode&&De.appendChild(Z),je=()=>{var Ke;return(Ke=Z.parentNode)==null?void 0:Ke.removeChild(Z)};return Ie?Oe():je(),()=>{je()}},y[15]=Z,y[16]=De,y[17]=Ie,y[18]=Se):Se=y[18];let $e;if(y[19]!==Z||y[20]!==Ie?($e=[Ie,Z],y[19]=Z,y[20]=Ie,y[21]=$e):$e=y[21],(0,s.L)(Se,$e),!(Ie&&ue))return null;let We;return y[22]!==ue||y[23]!==Z?(We=Z?(0,R.createPortal)(ue,Z):null,y[22]=ue,y[23]=Z,y[24]=We):We=y[24],We});B.displayName="Portal";const w=B;var Y=e(40549),k=e(57577);const ne="Escape",O=C=>{const{trigger:G,delay:y,disabled:oe,visible:re,clickOutsideClose:ue,triggerEl:ce,onVisibleChange:Q}=C,Ie=(0,n.useRef)(!1),Z=(0,n.useRef)(!1),me=(0,n.useRef)(null),H=(0,n.useRef)(0);(0,n.useEffect)(()=>{if(oe)return;const ae=Ee=>{var ee;!(ce==null||(ee=ce.contains)==null)&&ee.call(ce,Ee.target)||Ie.current||re&&ue&&(Q==null||Q(!1,{e:Ee,trigger:"document"}))};return document.addEventListener("mousedown",ae),document.addEventListener("touchend",ae),()=>{document.removeEventListener("mousedown",ae),document.removeEventListener("touchend",ae)}},[oe,re,ce,ue,Q]);function U(ae){y?(clearTimeout(me.current),me.current=setTimeout(ae,y)):ae()}function De(){return oe?{}:{onMouseEnter:ae=>{G==="hover"&&!Z.current&&(clearTimeout(me.current),Q==null||Q(!0,{e:ae,trigger:"hover"}))},onMouseLeave:ae=>{G==="hover"&&(Z.current=!0,clearTimeout(me.current),Q==null||Q(!1,{e:ae,trigger:"hover"}))},onMouseDown:()=>{clearTimeout(H.current),Ie.current=!0,H.current=window.setTimeout(()=>{Ie.current=!1})},onTouchEnd:()=>{clearTimeout(H.current),Ie.current=!0,H.current=window.setTimeout(()=>{Ie.current=!1})}}}function Be(ae){return oe?{}:{onMouseDown:ee=>{var se,le;G==="mousedown"&&U(()=>Q==null?void 0:Q(!re,{e:ee,trigger:"mousedown"})),(se=(le=ae.props).onMouseDown)==null||se.call(le,ee)},onClick:ee=>{var se,le;G==="click"&&(ee.preventDefault(),ee.stopPropagation(),U(()=>Q==null?void 0:Q(!re,{e:ee,trigger:"click"}))),(se=(le=ae.props).onClick)==null||se.call(le,ee)},onTouchStart:ee=>{var se,le;(G==="hover"||G==="mousedown")&&(Z.current=!1,U(()=>Q==null?void 0:Q(!0,{e:ee,trigger:"hover"}))),(se=(le=ae.props).onTouchStart)==null||se.call(le,ee)},onMouseEnter:ee=>{var se,le;G==="hover"&&(Z.current=!1,U(()=>Q==null?void 0:Q(!0,{e:ee,trigger:"hover"}))),(se=(le=ae.props).onMouseEnter)==null||se.call(le,ee)},onMouseLeave:ee=>{var se,le;G==="hover"&&(Z.current=!1,U(()=>Q==null?void 0:Q(!1,{e:ee,trigger:"hover"}))),(se=(le=ae.props).onMouseLeave)==null||se.call(le,ee)},onFocus:ee=>{var se,le;G==="focus"&&U(()=>Q==null?void 0:Q(!0,{e:ee,trigger:"focus"})),(se=(le=ae.props).onFocus)==null||se.call(le,ee)},onBlur:ee=>{var se,le;G==="focus"&&U(()=>Q==null?void 0:Q(!1,{e:ee,trigger:"blur"})),(se=(le=ae.props).onBlur)==null||se.call(le,ee)},onContextMenu:ee=>{var se,le;G==="context-menu"&&(ee.preventDefault(),U(()=>Q==null?void 0:Q(!0,{e:ee,trigger:"context-menu"}))),(se=(le=ae.props).onContextMenu)==null||se.call(le,ee)},onKeyDown:ee=>{var se,le;(ee==null?void 0:ee.key)===ne&&U(()=>Q==null?void 0:Q(!1,{e:ee,trigger:"keydown-esc"})),(se=(le=ae.props).onKeyDown)==null||se.call(le,ee)}}}return{genPopupProps:De,genTriggerProps:Be}};function z(C,G,y){const{top:oe,left:re,width:ue,height:ce}=C.getBoundingClientRect(),Q=oe+y,Ie=re+G;return{width:ue,height:ce,top:Q,bottom:Q+ce,left:Ie,right:Ie+ue}}function $(C,G,y){const oe=z(C,G,y),re=C.clientWidth,ue=C.clientHeight,ce=oe.left+C.clientLeft,Q=oe.top+C.clientTop;return{width:re,height:ue,top:Q,bottom:Q+ue,left:ce,right:ce+re}}function J(C){if(!C||C.tagName==="HTML")return;const G=window.getComputedStyle(C),y=oe=>["auto","scroll"].includes(oe);return C.clientHeight<C.scrollHeight&&y(G.overflowX)||C.clientWidth<C.scrollWidth&&y(G.overflowY)?C:J(C.parentNode)}function V(C,G){return Math.round(Math.abs(C))>Math.round(Math.abs(G))?C:G}const j=(C,G)=>`translate3d(${C}px, ${G}px, 0)`;function te(C){if(!C)return[0,0];const G=window.getComputedStyle(C),y=G.transform||G.webkitTransform||"none";if(y==="none")return[0,0];if(y.match(/matrix\(([^)]+)\)/)){var oe,re;const Q=((re=y.match(/matrix\((.+)\)/))==null||(oe=re[1])==null?void 0:oe.split(",").map(Number))||[0,0];if(Q.length===6)return[Q[4],Q[5]]}const[,ue=0,ce=0]=(y.match(/translate\((.*?)px,\s(.*?)px\)/)||[]).map(Q=>Number(Q));return[ue,ce]}function P(C){const G=C.split("-"),y=G[0],oe=G[1];let re;const ue=y==="top"||y==="bottom",ce=y==="left"||y==="right";return ue&&(oe==="start"&&(re="left"),oe==="end"&&(re="right")),ce&&(oe==="start"&&(re="top"),oe==="end"&&(re="bottom")),[y,re,ue,ce]}function S(C){return C?(0,T.Kn)(C)?[C.x||0,C.y||0]:[C||0,C||0]:[0,0]}const W={direction:"bottom",enableFlip:!0,enableShift:!0};function X(C,G){const{reference:y,popper:oe,arrow:re}=C;if(!y||!oe)return;const ue=K(K({},W),G),ce=oe.parentNode,[Q,Ie]=te(ce),Z=window.pageYOffset,me=window.pageXOffset,H=z(y,me,Z),U=z(oe,me,Z),De=H.width-U.width,Be=H.height-U.height;let ae=H.left-U.left+Q,Ee=H.top-U.top+Ie;const[ee,se,le,we]=P(ue.direction);let Ce=ee;const Se=se==="left"?0:se==="right"?De:De/2,$e=De-Se,We=se==="top"?0:se==="bottom"?Be:Be/2,Oe=Be-We;le&&(ae+=Se,Ee+=ee==="top"?-U.height:H.height),we&&(ae+=ee==="left"?-U.width:H.width,Ee+=We);let je=J(y);const[Ke,de]=S(ue.offset),{height:he=0,width:Me=0}=re?z(re,me,Z):{};let Le=0,Ze=0;for(;je;){const Re=$(je,me,Z);Fe(Re),je=J(je.parentNode)}const{clientHeight:Ye,clientWidth:Ge}=document.documentElement;Fe({top:Z,bottom:Z+Ye,left:me,right:me+Ge,height:Ye,width:Ge}),ae-=Le,Ee-=Ze,Je(),le&&(Ee+=Ce==="bottom"?de:-de),we&&(ae+=Ce==="right"?Ke:-Ke),ce.style.transform=j(ae,Ee),ce.setAttribute("data-direction",Ce);function Fe(Re){const{top:fe,bottom:ze,left:Ne,right:Ve,height:ke,width:nn}=Re;if(le){const Te=Math.round(H.top-fe+H.height/2),Ae=Math.round(ke/2);ue.enableFlip&&tn(Te,Ae),ue.enableShift&&on()}if(we){const Te=Math.round(H.left-Ne+H.width/2),Ae=Math.round(nn/2);ue.enableFlip&&an(Te,Ae),ue.enableShift&&rn()}function tn(Te,Ae){const Xe=H.top-(U.height+de+he)<fe,Qe=H.bottom+U.height+de+he>ke+fe;Xe&&Te<=Ae&&Ce==="top"?(Ee+=U.height+H.height,Ce="bottom"):Qe&&Te>=Ae&&Ce==="bottom"&&(Ee-=U.height+H.height,Ce="top")}function on(){if(H.left+Se<Ne){const Te=H.left+Se-Ne,Ae=H.right-Me>Ne?Te:-H.width+Se+Me;Le=V(Ae,Le)}if(H.right-$e>Ve){const Te=H.right-$e-Ve,Ae=H.left+Me<Ve?Te:H.width-$e-Me;Le=V(Ae,Le)}}function an(Te,Ae){const Xe=H.left-(U.width+Ke+Me)<Ne,Qe=H.right+U.width+Ke+Me>Ve;Xe&&Te<Ae&&Ce==="left"?(ae+=H.width+U.width,Ce="right"):Qe&&Te>Ae&&Ce==="right"&&(ae-=H.width+U.width,Ce="left")}function rn(){if(H.top+We<fe){const Te=H.top+We-fe,Ae=H.bottom-he>fe?Te:-H.height+We+he;Ze=V(Ae,Ze)}if(H.bottom-Oe>ze){const Te=H.bottom-Oe-ze,Ae=H.top+he<ze?Te:H.height-Oe-he;Ze=V(Ae,Ze)}}}function Je(){if(!re)return;le?Ee+=Ce==="bottom"?he:-he:we&&(ae+=Ce==="right"?Me:-Me);const Re=ue.direction.split("-")[1]||"center",fe={x:0,y:0};if(le){fe.y=Ce==="top"?U.height:-he;const ze=Math.abs(H.width-U.width)>Math.abs(Le),Ne=Le===0;Re==="start"?Ne?fe.x=0:fe.x=Math.min(Math.max(0,Le),U.width-Me):Re==="center"?Ne?fe.x=(U.width-Me)/2:ze?fe.x=(U.width-Me)/2+Le:fe.x=Math.max(0,Math.min(U.width-Me,(U.width-Me)/2+Le)):Re==="end"&&(Ne?fe.x=U.width-Me:fe.x=Math.max(0,Math.min(U.width-Me,U.width-Me+Le)))}else if(we){fe.x=Ce==="left"?U.width:-Me;const ze=Ze===0,Ne=Math.abs(H.height-U.height)>Math.abs(Ze);Re==="start"?ze?fe.y=0:fe.y=Math.min(Math.max(0,Ze),U.height-he):Re==="center"?ze?fe.y=(U.height-he)/2:Ne?fe.y=(U.height-he)/2+Ze:fe.y=Math.max(0,Math.min(U.height-he,(U.height-he)/2+Ze)):Re==="end"&&(ze?fe.y=U.height-he:fe.y=Math.max(0,Math.min(U.height-he,U.height-he+Ze)))}re.style.transform=j(fe.x,fe.y)}}function A(C){let G=arguments.length>1&&arguments[1]!==void 0?arguments[1]:[];if(!C)return[];const y=pe(C);if(y===C.ownerDocument.body){const ue=window.visualViewport?[window.visualViewport]:[],ce=F(y)?[y]:[];return[...G,window,...ue,...ce]}const re=A(xe(y));return[...G,y,...re]}function xe(C){return D(C)==="html"?C:C.parentNode}function F(C){const{overflow:G,overflowX:y,overflowY:oe,display:re}=getComputedStyle(C);return/auto|scroll|overlay|hidden|clip/.test(G+oe+y)&&!["contents"].includes(re)}const ie=new Set(["html","body","#document"]);function pe(C){return ie.has(D(C))?C.ownerDocument.body:F(C)?C:pe(xe(C))}function D(C){return C?(C.nodeName||"").toLowerCase():null}function L(C){let G;return()=>(G||(G=new Promise(y=>{Promise.resolve().then(()=>{G=void 0,y(C())})})),G)}const q={direction:"bottom",enableFlip:!0,enableShift:!0,offset:0,zIndex:0,trigger:"hover",delay:100,clickOutsideClose:!0,disabled:!1},b={unmountOnExit:!0},ve={position:"absolute",top:0,left:0,bottom:"auto",right:"auto",margin:0,willChange:"transform"},ye=K({},ve),_=K({},ve),ge=(0,n.forwardRef)((C,G)=>{const{prefixCls:y,componentConfig:oe}=(0,n.useContext)(k.E),{children:re,popper:ue,enableShift:ce,motion:Q={},enableFlip:Ie,offset:Z,direction:me,getContainer:H,zIndex:U,trigger:De,delay:Be,disabled:ae,visible:Ee,arrow:ee,clickOutsideClose:se,onVisibleChange:le}=(0,r.S)(C,q,oe==null?void 0:oe.Trigger),we=(0,r.S)(b,Q),Ce=(0,n.isValidElement)(re),Se=(0,n.useRef)(null),$e=(0,n.useRef)(null),We=d(ue),Oe=(0,n.useRef)(null),je=(0,l.x1)(We,Oe),Ke=(0,n.useRef)(null),[de,he]=(0,p.R)(Ee,{onChange:le}),{genPopupProps:Me,genTriggerProps:Le}=O({clickOutsideClose:se,delay:Be,disabled:ae,visible:de,onVisibleChange:he,trigger:De,triggerEl:Se.current});(0,n.useImperativeHandle)(G,()=>{});const Ze=(0,l.t4)(re),Ye=(0,l.t4)(ue),Ge=(0,n.useCallback)(Re=>{var fe;Re&&Re.type!=="resize"&&!((fe=Re.target)!=null&&fe.contains(Se.current))||setTimeout(()=>{X({reference:Se.current,popper:Oe.current,arrow:$e.current},{direction:me,enableFlip:Ie,enableShift:ce,offset:Z})})},[me,Ie,ce,Z]),Fe=L(()=>new Promise(Re=>{Ge(),Re(void 0)}));if((0,s.L)(()=>{if(de!==void 0){if(Fe(),de===!0){var Re;(Re=Ke.current)==null||Re.toggle(!0)}else if(de===!1){var fe;(fe=Ke.current)==null||fe.toggle(!1)}}},[de]),(0,s.L)(()=>{Fe();const Re=A(Se.current),fe=A(Oe.current),ze=[...Re,...fe];return ze.forEach(Ne=>{Ne.addEventListener("scroll",Fe,{passive:!0})}),window.addEventListener("resize",Fe,{passive:!0}),()=>{ze.forEach(Ne=>{Ne.removeEventListener("scroll",Fe)}),window.removeEventListener("resize",Fe)}},[me,Ie,ce,Z,Oe.current,$e.current]),!Ce)return;const Je=()=>ue?n.createElement(Y.Z,K({ref:Ke},we),Re=>{let{className:fe}=Re;return n.createElement(w,{getContainer:H},n.createElement("div",Pe(K({},Me()),{className:(0,m.default)(`${y}-trigger`,fe),style:Pe(K({},ye),{zIndex:U})}),ee?n.createElement("div",{className:`${y}-trigger-arrow`},(0,n.cloneElement)(ee,{ref:$e,style:K(Pe(K({},_),{zIndex:U}),ee.props.style||{})})):null,(0,n.cloneElement)(ue,{ref:je})))}):null;return n.createElement(n.Fragment,null,n.createElement(i,{ref:Se,onResize:()=>Fe()},(0,n.cloneElement)(re,K({},Le(re)))),Je())});ge.displayName="Trigger";const be=ge},36112:function(x,t,e){"use strict";e.r(t),e.d(t,{Trigger:function(){return a},default:function(){return v}});var n=e(67171),m=e(98479),r=e.n(m),p={};for(var s in m)["default","Trigger"].indexOf(s)<0&&(p[s]=function(I){return m[I]}.bind(0,s));e.d(t,p);const a=n.Z,v=a},98479:function(){},84176:function(x,t,e){var n=e(75863);function m(r,p){if(r==null)return{};var s=n(r,p),a,v;if(Object.getOwnPropertySymbols){var I=Object.getOwnPropertySymbols(r);for(v=0;v<I.length;v++)a=I[v],!(p.indexOf(a)>=0)&&Object.prototype.propertyIsEnumerable.call(r,a)&&(s[a]=r[a])}return s}x.exports=m,x.exports.__esModule=!0,x.exports.default=x.exports},75863:function(x){function t(e,n){if(e==null)return{};var m={},r=Object.keys(e),p,s;for(s=0;s<r.length;s++)p=r[s],!(n.indexOf(p)>=0)&&(m[p]=e[p]);return m}x.exports=t,x.exports.__esModule=!0,x.exports.default=x.exports},7829:function(x,t,e){"use strict";e.r(t),e.d(t,{clsx:function(){return m}});function n(r){var p,s,a="";if(typeof r=="string"||typeof r=="number")a+=r;else if(typeof r=="object")if(Array.isArray(r)){var v=r.length;for(p=0;p<v;p++)r[p]&&(s=n(r[p]))&&(a&&(a+=" "),a+=s)}else for(s in r)r[s]&&(a&&(a+=" "),a+=s);return a}function m(){for(var r,p,s=0,a="",v=arguments.length;s<v;s++)(r=arguments[s])&&(p=n(r))&&(a&&(a+=" "),a+=p);return a}t.default=m},64508:function(x,t,e){"use strict";e.d(t,{Y:function(){return p}});var n=e(53360),m=e(75601);const r=(s,a,v,I,h)=>{clearTimeout(I.current);const u=(0,m.y0)(s);a(u),v.current=u,h&&h({current:u})},p=({enter:s=!0,exit:a=!0,preEnter:v,preExit:I,timeout:h,initialEntered:u,mountOnEnter:c,unmountOnExit:d,onStateChange:l}={})=>{const[f,i]=(0,n.useState)(()=>(0,m.y0)(u?m.cn:(0,m.Ef)(c))),o=(0,n.useRef)(f),R=(0,n.useRef)(),[E,T]=(0,m.fj)(h),g=(0,n.useCallback)(()=>{const B=(0,m.XZ)(o.current._s,d);B&&r(B,i,o,R,l)},[l,d]),M=(0,n.useCallback)(B=>{const w=k=>{switch(r(k,i,o,R,l),k){case m.d0:E>=0&&(R.current=setTimeout(g,E));break;case m.Ix:T>=0&&(R.current=setTimeout(g,T));break;case m.iL:case m.iU:R.current=(0,m.Y3)(w,k);break}},Y=o.current.isEnter;typeof B!="boolean"&&(B=!Y),B?!Y&&w(s?v?m.iL:m.d0:m.cn):Y&&w(a?I?m.iU:m.Ix:(0,m.Ef)(d))},[g,l,s,a,v,I,E,T,d]);return[f,M,g]}},75601:function(x,t,e){"use strict";e.d(t,{Ef:function(){return u},Ix:function(){return s},XZ:function(){return c},Y3:function(){return l},cn:function(){return r},d0:function(){return m},fj:function(){return d},iL:function(){return n},iU:function(){return p},y0:function(){return h}});const n=0,m=1,r=2,p=3,s=4,a=5,v=6,I=["preEnter","entering","entered","preExit","exiting","exited","unmounted"],h=f=>({_s:f,status:I[f],isEnter:f<p,isMounted:f!==v,isResolved:f===r||f>s}),u=f=>f?v:a,c=(f,i)=>{switch(f){case m:case n:return r;case s:case p:return u(i)}},d=f=>typeof f=="object"?[f.enter,f.exit]:[f,f],l=(f,i)=>setTimeout(()=>{isNaN(document.body.offsetTop)||f(i+1)},0)}}]);
}());