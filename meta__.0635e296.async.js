...
`},27833:function(x,t,e){"use no memo";"use strict";var n=Object.create,m=Object.defineProperty,r=Object.getOwnPropertyDescriptor,p=Object.getOwnPropertyNames,s=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,v=(R,S)=>{for(var B in S)m(R,B,{get:S[B],enumerable:!0})},I=(R,S,B,z)=>{if(S&&typeof S=="object"||typeof S=="function")for(let H of p(S))!a.call(R,H)&&H!==B&&m(R,H,{get:()=>S[H],enumerable:!(z=r(S,H))||z.enumerable});return R},h=(R,S,B)=>(B=R!=null?n(s(R)):{},I(S||!R||!R.__esModule?m(B,"default",{value:R,enumerable:!0}):B,R)),u=R=>I(m({},"__esModule",{value:!0}),R),c={};v(c,{$dispatcherGuard:()=>k,$makeReadOnly:()=>N,$reset:()=>ne,$structuralCheck:()=>te,c:()=>g,clearRenderCounterRegistry:()=>Z,renderCounterRegistry:()=>O,useRenderCounter:()=>G}),x.exports=u(c);var d=h(e(53360)),{useRef:l,useEffect:f,isValidElement:i}=d,o,P=(o=d.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE)!=null?o:d.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,E=Symbol.for("react.memo_cache_sentinel"),A,g=typeof((A=d.__COMPILER_RUNTIME)==null?void 0:A.c)=="function"?d.__COMPILER_RUNTIME.c:function(S){return d.useMemo(()=>{const B=new Array(S);for(let z=0;z<S;z++)B[z]=E;return B[E]=!0,B},[])},M={};["readContext","useCallback","useContext","useEffect","useImperativeHandle","useInsertionEffect","useLayoutEffect","useMemo","useReducer","useRef","useState","useDebugValue","useDeferredValue","useTransition","useMutableSource","useSyncExternalStore","useId","unstable_isNewReconciler","getCacheSignal","getCacheForType","useCacheRefresh"].forEach(R=>{M[R]=()=>{throw new Error(`[React] Unexpected React hook call (${R}) from a React compiled function. Check that all hooks are called directly and named according to convention ('use[A-Z]') `)}});var L=null;M.useMemoCache=R=>{if(L==null)throw new Error("React Compiler internal invariant violation: unexpected null dispatcher");return L.useMemoCache(R)};function w(R){return P.ReactCurrentDispatcher.current=R,P.ReactCurrentDispatcher.current}var J=[];function k(R){const S=P.ReactCurrentDispatcher.current;if(R===0){if(J.push(S),J.length===1&&(L=S),S===M)throw new Error("[React] Unexpected call to custom hook or component from a React compiled function. Check that (1) all hooks are called directly and named according to convention ('use[A-Z]') and (2) components are returned as JSX instead of being directly invoked.");w(M)}else if(R===1){const B=J.pop();if(B==null)throw new Error("React Compiler internal error: unexpected null in guard stack");J.length===0&&(L=null),w(B)}else if(R===2)J.push(S),w(L);else if(R===3){const B=J.pop();if(B==null)throw new Error("React Compiler internal error: unexpected null in guard stack");w(B)}else throw new Error("React Compiler internal error: unreachable block"+R)}function ne(R){for(let S=0;S<R.length;S++)R[S]=E}function N(){throw new Error("TODO: implement $makeReadOnly in react-compiler-runtime")}var O=new Map;function Z(){for(const R of O.values())R.forEach(S=>{S.count=0})}function $(R,S){let B=O.get(R);B==null&&(B=new Set,O.set(R,B)),B.add(S)}function X(R,S){const B=O.get(R);B!=null&&B.delete(S)}function G(R){const S=l(null);S.current!=null&&(S.current.count+=1),f(()=>{if(S.current==null){const B={count:0};$(R,B),S.current=B}return()=>{S.current!==null&&X(R,S.current)}})}var j=new Set;function te(R,S,B,z,H,he){function V(D,T,q,b){const ve=`${z}:${he} [${H}] ${B}${q} changed from ${D} to ${T} at depth ${b}`;j.has(ve)||(j.add(ve),console.error(ve))}const de=2;function pe(D,T,q,b){if(!(b>de)){if(D===T)return;if(typeof D!=typeof T)V(`type ${typeof D}`,`type ${typeof T}`,q,b);else if(typeof D=="object"){const ve=Array.isArray(D),Ee=Array.isArray(T);if(D===null&&T!==null)V("null",`type ${typeof T}`,q,b);else if(T===null)V(`type ${typeof D}`,"null",q,b);else if(D instanceof Map)if(!(T instanceof Map))V("Map instance","other value",q,b);else if(D.size!==T.size)V(`Map instance with size ${D.size}`,`Map instance with size ${T.size}`,q,b);else for(const[_,ge]of D)T.has(_)?pe(ge,T.get(_),`${q}.get(${_})`,b+1):V(`Map instance with key ${_}`,`Map instance without key ${_}`,q,b);else if(T instanceof Map)V("other value","Map instance",q,b);else if(D instanceof Set)if(!(T instanceof Set))V("Set instance","other value",q,b);else if(D.size!==T.size)V(`Set instance with size ${D.size}`,`Set instance with size ${T.size}`,q,b);else for(const _ of T)D.has(_)||V(`Set instance without element ${_}`,`Set instance with element ${_}`,q,b);else if(T instanceof Set)V("other value","Set instance",q,b);else if(ve||Ee)if(ve!==Ee)V(`type ${ve?"array":"object"}`,`type ${Ee?"array":"object"}`,q,b);else if(D.length!==T.length)V(`array with length ${D.length}`,`array with length ${T.length}`,q,b);else for(let _=0;_<D.length;_++)pe(D[_],T[_],`${q}[${_}]`,b+1);else if(i(D)||i(T))i(D)!==i(T)?V(`type ${i(D)?"React element":"object"}`,`type ${i(T)?"React element":"object"}`,q,b):D.type!==T.type?V(`React element of type ${D.type}`,`React element of type ${T.type}`,q,b):pe(D.props,T.props,`[props of ${q}]`,b+1);else{for(const _ in T)_ in D||V(`object without key ${_}`,`object with key ${_}`,q,b);for(const _ in D)_ in T?pe(D[_],T[_],`${q}.${_}`,b+1):V(`object with key ${_}`,`object without key ${_}`,q,b)}}else{if(typeof D=="function")return;isNaN(D)||isNaN(T)?isNaN(D)!==isNaN(T)&&V(`${isNaN(D)?"NaN":"non-NaN value"}`,`${isNaN(T)?"NaN":"non-NaN value"}`,q,b):D!==T&&V(D,T,q,b)}}}pe(R,S,"",0)}},11607:function(x,t){"use strict";var e=Symbol.for("react.transitional.element"),n=Symbol.for("react.portal"),m=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),p=Symbol.for("react.profiler");Symbol.for("react.provider");var s=Symbol.for("react.consumer"),a=Symbol.for("react.context"),v=Symbol.for("react.forward_ref"),I=Symbol.for("react.suspense"),h=Symbol.for("react.suspense_list"),u=Symbol.for("react.memo"),c=Symbol.for("react.lazy"),d=Symbol.for("react.view_transition"),l=Symbol.for("react.client.reference");function f(i){if(typeof i=="object"&&i!==null){var o=i.$$typeof;switch(o){case e:switch(i=i.type,i){case m:case p:case r:case I:case h:case d:return i;default:switch(i=i&&i.$$typeof,i){case a:case v:case c:case u:return i;case s:return i;default:return o}}case n:return o}}}t.ContextConsumer=s,t.ContextProvider=a,t.Element=e,t.ForwardRef=v,t.Fragment=m,t.Lazy=c,t.Memo=u,t.Portal=n,t.Profiler=p,t.StrictMode=r,t.Suspense=I,t.SuspenseList=h,t.isContextConsumer=function(i){return f(i)===s},t.isContextProvider=function(i){return f(i)===a},t.isElement=function(i){return typeof i=="object"&&i!==null&&i.$$typeof===e},t.isForwardRef=function(i){return f(i)===v},t.isFragment=function(i){return f(i)===m},t.isLazy=function(i){return f(i)===c},t.isMemo=function(i){return f(i)===u},t.isPortal=function(i){return f(i)===n},t.isProfiler=function(i){return f(i)===p},t.isStrictMode=function(i){return f(i)===r},t.isSuspense=function(i){return f(i)===I},t.isSuspenseList=function(i){return f(i)===h},t.isValidElementType=function(i){return typeof i=="string"||typeof i=="function"||i===m||i===p||i===r||i===I||i===h||typeof i=="object"&&i!==null&&(i.$$typeof===c||i.$$typeof===u||i.$$typeof===a||i.$$typeof===s||i.$$typeof===v||i.$$typeof===l||i.getModuleId!==void 0)},t.typeOf=f},81184:function(x,t,e){"use strict";x.exports=e(11607)},37797:function(x,t,e){"use strict";e.d(t,{D:function(){return m}});var n=e(53360);function m(r,p,s){const a=(0,n.useRef)({});return(!("value"in a.current)||s(a.current.condition,p))&&(a.current.value=r(),a.current.condition=p),a.current.value}},60164:function(x,t,e){"use strict";e.d(t,{L:function(){return p}});var n=e(53360),m=e(34028);const p=(0,m.J)()?n.useLayoutEffect:n.useEffect},7657:function(x,t,e){"use strict";e.d(t,{S:function(){return m}});var n=e(53360);function m(r){let p=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};return(0,n.useMemo)(()=>{const a=W(W({},p),s),v=W({},r);for(const I in a)v[I]===void 0&&(v[I]=a[I]);return v},[r,p,s])}},62222:function(x,t,e){"use strict";e.d(t,{R:function(){return p}});var n=e(53360),m=e(80703),r=e(45844);function p(s,a){const{defaultValue:v,value:I,onChange:h}=a||{},[u,c]=(0,n.useState)(()=>(0,m.o8)(I)?(0,m.o8)(v)?(0,m.mf)(s)?s():s:(0,m.mf)(v)?v():v:I),d=(0,r.D)(I),l=(0,n.useRef)(!0);(0,n.useEffect)(()=>{if(l.current){l.current=!1;return}(0,m.o8)(I)&&d.current!==I&&c(I)},[I]);const f=(0,m.o8)(I)?u:I,i=(0,n.useCallback)(o=>{const P=(0,m.mf)(o)?o(f):o;(0,m.o8)(I)&&c(P),!Object.is(P,f)&&(h==null||h(P))},[u,f]);return[f,i]}},45844:function(x,t,e){"use strict";e.d(t,{D:function(){return m}});var n=e(53360);function m(r){const p=(0,n.useRef)(void 0);return(0,n.useEffect)(()=>{p.current=r},[r]),p}},8240:function(x,t,e){"use strict";e.d(t,{y:function(){return s}});var n=e(53360),m=e(20759),r=e(34028),p=e(60164);function s(a,v){let I=arguments.length>2&&arguments[2]!==void 0?arguments[2]:!0;const h=(0,n.useRef)(null);h.current=v,(0,p.L)(()=>{let u=null;if(!I||!(0,r.J)()||!a)return;const c=d=>{var l;(l=h.current)==null||l.call(h,d)};return u=new m.Z(c),u.observe(a),()=>{if(u&&a){var d;u.unobserve(a),(d=u.disconnect)==null||d.call(u),u=null}}},[a,I])}},31136:function(x,t,e){"use strict";e.d(t,{Z:function(){return r}});var n=e(53360);const r=(0,n.createContext)({})},37907:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(7829),r=e(31136);const p=(0,n.forwardRef)((a,v)=>{const E=a,{svg:I,type:h,spin:u,rotate:c,className:d,style:l}=E,f=Ue(E,["svg","type","spin","rotate","className","style"]),{prefixCls:i="sqi"}=(0,n.useContext)(r.Z),o=(0,m.default)(`${i}-icon`,{[`${i}-icon-spin`]:!!u&&!!I},d),P=l||{};return Number.isSafeInteger(c)&&(P.transform=`rotate(${c}deg)`),n.createElement("span",W({role:"img",ref:v,"aria-label":h,className:o,style:P},f),I)});p.displayName="Icon";const s=p},46874:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M13 4V11L20 11V13L13 13V20H11L11 13H4L4 11L11 11L11 4L13 4Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"add",ref:v},a)));p.displayName="AddIcon";const s=p},1824:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("g",{clipPath:"url(#clip0_8726_7319)"},(0,n.createElement)("path",{d:"M2.09675 12C3.53842 16.0792 7.42915 19 11.9996 19C16.57 19 20.4607 16.0792 21.9024 12C20.4607 7.92079 16.57 5 11.9996 5C7.42915 5 3.53842 7.92079 2.09675 12ZM0.0892162 11.696C1.69842 6.65364 6.42102 3 11.9996 3C17.5781 3 22.3007 6.65364 23.9099 11.696L24.007 12L23.9099 12.304C22.3007 17.3464 17.5781 21 11.9996 21C6.42102 21 1.69842 17.3464 0.0892162 12.304L-0.0078125 12L0.0892162 11.696ZM11.9999 9C10.343 9 8.99989 10.3431 8.99989 12C8.99989 13.6569 10.343 15 11.9999 15C13.6567 15 14.9999 13.6569 14.9999 12C14.9999 10.3431 13.6567 9 11.9999 9ZM6.99989 12C6.99989 9.23858 9.23846 7 11.9999 7C14.7613 7 16.9999 9.23858 16.9999 12C16.9999 14.7614 14.7613 17 11.9999 17C9.23846 17 6.99989 14.7614 6.99989 12Z",fill:"currentColor"})))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"browse",ref:v},a)));p.displayName="BrowseIcon";const s=p},85569:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 26 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M3.99999 1.58582L10.1714 7.75774L17.2425 14.8288L23.4137 21L21.9995 22.4142L19.0345 19.4492C17.2447 20.4377 15.1866 21.0001 12.9996 21.0001C7.42102 21.0001 2.69842 17.3465 1.08922 12.3042L0.992188 12.0001L1.08922 11.6961C1.85645 9.29201 3.33009 7.20571 5.26511 5.67975L2.58567 2.99993L3.99999 1.58582ZM6.69098 7.10574C5.05507 8.33729 3.79122 10.0353 3.09676 12.0001C4.53843 16.0793 8.42915 19.0001 12.9996 19.0001C14.6314 19.0001 16.1745 18.6285 17.5507 17.9655L15.7571 16.1719C14.9668 16.695 14.0185 17.0003 12.9999 17.0003C10.2385 17.0003 7.99989 14.7618 7.99989 12.0003C7.99989 10.9817 8.3052 10.0334 8.82835 9.24312L6.69098 7.10574ZM10.292 10.7068C10.1046 11.0984 9.99989 11.5368 9.99989 12.0003C9.99989 13.6572 11.343 15.0003 12.9999 15.0003C13.4634 15.0003 13.9018 14.8956 14.2934 14.7082L10.292 10.7068ZM13 5.00003C12.4234 5.00003 11.8583 5.04642 11.3081 5.13548L10.321 5.29527L10.0014 3.32097L10.9885 3.16117C11.644 3.05508 12.3159 3.00003 13 3.00003C18.5786 3.00003 23.3012 6.65367 24.9104 11.696L25.0074 12L24.9104 12.3041C24.4968 13.5999 23.878 14.8034 23.0926 15.8763L22.5019 16.6833L20.8881 15.5019L21.4788 14.695C22.0769 13.8778 22.5595 12.9715 22.9028 12C21.4612 7.92082 17.5704 5.00003 13 5.00003ZM13.5132 6.92636L14.4691 7.21985C16.0499 7.70515 17.2953 8.95049 17.7806 10.5313L18.0741 11.4873L16.1621 12.0742L15.8687 11.1183C15.578 10.1715 14.829 9.42243 13.8822 9.13178L12.9262 8.8383L13.5132 6.92636Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"browse-off",ref:v},a)));p.displayName="BrowseOffIcon";const s=p},23436:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23ZM7.49985 10.5858L10.4999 13.5858L16.4999 7.58578L17.9141 8.99999L10.4999 16.4142L6.08564 12L7.49985 10.5858Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"check-circle-filled",ref:v},a)));p.displayName="CheckCircleFilledIcon";const s=p},46608:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M17.5001 8.08582L12.0002 13.5858L6.50015 8.08582L5.08594 9.50003L12.0002 16.4142L18.9144 9.50003L17.5001 8.08582Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"chevron-down",ref:v},a)));p.displayName="ChevronDownIcon";const s=p},58360:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23ZM8.81753 7.40346L11.9999 10.5858L15.1815 7.40414L16.5957 8.81835L13.4141 12L16.5957 15.1816L15.1815 16.5958L11.9999 13.4142L8.81753 16.5965L7.40332 15.1823L10.5856 12L7.40332 8.81767L8.81753 7.40346Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"close-circle-filled",ref:v},a)));p.displayName="CloseCircleFilledIcon";const s=p},27377:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M7.04996 5.63599L11.9997 10.5857L16.9494 5.63599L18.3637 7.0502L13.4139 11.9999L18.3637 16.9497L16.9494 18.3639L11.9997 13.4142L7.04996 18.3639L5.63574 16.9497L10.5855 11.9999L5.63574 7.0502L7.04996 5.63599Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"close",ref:v},a)));p.displayName="CloseIcon";const s=p},50397:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23ZM10.996 8.50002V6.49611H12.9999V8.50002H10.996ZM12.9999 10L12.9999 17.5H10.9999V10L12.9999 10Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"info-circle-filled",ref:v},a)));p.displayName="InfoCircleFilledIcon";const s=p},60333:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 2.25C6.61556 2.25 2.25 6.61556 2.25 12C2.25 17.3844 6.61556 21.75 12 21.75V19.3125C7.96142 19.3125 4.6875 16.0386 4.6875 12C4.6875 7.96142 7.96142 4.6875 12 4.6875C16.0386 4.6875 19.3125 7.96142 19.3125 12H21.75C21.75 6.61556 17.3844 2.25 12 2.25Z",fill:"currentColor",fillOpacity:.9}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"loading",ref:v},a)));p.displayName="LoadingIcon";const s=p},36106:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M15.0962 5.90381C12.5578 3.3654 8.44221 3.3654 5.90381 5.90381C3.3654 8.44221 3.3654 12.5578 5.90381 15.0962C8.44221 17.6346 12.5578 17.6346 15.0962 15.0962C17.6346 12.5578 17.6346 8.44221 15.0962 5.90381ZM4.48959 4.48959C7.80905 1.17014 13.191 1.17014 16.5104 4.48959C19.5906 7.56983 19.8126 12.4259 17.1764 15.7621L22.5208 21.1066L21.1066 22.5208L15.7621 17.1764C12.4259 19.8126 7.56983 19.5906 4.48959 16.5104C1.17014 13.191 1.17014 7.80905 4.48959 4.48959Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"search",ref:v},a)));p.displayName="SearchIcon";const s=p},65466:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 2.58569L17.9142 8.49991L16.5 9.91412L13 6.41412L13 15.9999H11L11 6.41412L7.5 9.91412L6.08579 8.49991L12 2.58569ZM4.5 13.9999V18.9999H19.5V13.9999H21.5V20.9999H2.5V13.9999H4.5Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"upload",ref:v},a)));p.displayName="UploadIcon";const s=p},21925:function(x,t,e){"use strict";e.d(t,{Z:function(){return s}});var n=e(53360),m=e(37907);function r(a){return(0,n.createElement)("svg",W({viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",focusable:"false","aria-hidden":"true"},a),(0,n.createElement)("path",{d:"M12 1C18.0751 1 23 5.92487 23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1ZM11.0001 14H13.0001V6.49998H11.0001V14ZM13.004 15.5H11.0001V17.5039H13.004V15.5Z",fill:"currentColor"}))}const p=(0,n.forwardRef)((a,v)=>(0,n.createElement)(m.Z,W({svg:(0,n.createElement)(r),type:"warn-circle-filled",ref:v},a)));p.displayName="WarnCircleFilledIcon";const s=p},5629:function(x,t,e){"use strict";e.r(t),e.d(t,{AddIcon:function(){return r.Z},BrowseIcon:function(){return s.Z},BrowseOffIcon:function(){return p.Z},CheckCircleFilledIcon:function(){return a.Z},ChevronDownIcon:function(){return v.Z},CloseCircleFilledIcon:function(){return I.Z},CloseIcon:function(){return h.Z},IconContext:function(){return m.Z},InfoCircleFilledIcon:function(){return u.Z},LoadingIcon:function(){return c.Z},SearchIcon:function(){return d.Z},UploadIcon:function(){return l.Z},WarnCircleFilledIcon:function(){return f.Z},default:function(){return i}});var n=e(37907),m=e(31136),r=e(46874),p=e(85569),s=e(1824),a=e(23436),v=e(46608),I=e(58360),h=e(27377),u=e(50397),c=e(60333),d=e(36106),l=e(65466),f=e(21925);const i=n.Z},34028:function(x,t,e){"use strict";e.d(t,{J:function(){return n}});function n(){return!!(typeof window!="undefined"&&window.document&&window.document.createElement)}},78831:function(x,t,e){"use strict";e.d(t,{D:function(){return n}});function n(m,r){let p=null;const s=function(){for(var a=arguments.length,v=new Array(a),I=0;I<a;I++)v[I]=arguments[I];p&&clearTimeout(p),p=setTimeout(()=>{m.apply(this,v),p=null},r)};return s.cancel=()=>{p&&(clearTimeout(p),p=null)},s}},80703:function(x,t,e){"use strict";e.d(t,{HD:function(){return s},Kn:function(){return a},Qr:function(){return v},hj:function(){return I},kJ:function(){return p},mf:function(){return m},o8:function(){return r}});const n=Object.prototype.toString;function m(h){return n.call(h)==="[object Function]"}function r(h){return h===void 0}function p(h){return n.call(h)==="[object Array]"}function s(h){return n.call(h)==="[object String]"}const a=h=>n.call(h)==="[object Object]",v=h=>{if(!a(h))return!0;for(const u in h)if(Object.prototype.hasOwnProperty.call(h,u))return!1;return!0},I=h=>n.call(h)==="[object Number]"&&h===h},12598:function(x,t,e){"use strict";e.d(t,{C:function(){return n}});function n(m,r){const p=Object.assign({},m);return Array.isArray(r)&&r.forEach(s=>{delete p[s]}),p}},6890:function(x,t,e){"use strict";e.d(t,{P:function(){return m}});var n=e(78831);function m(r,p){let s=null;const a=(0,n.D)(r,p),v=function(){for(var I=arguments.length,h=new Array(I),u=0;u<I;u++)h[u]=arguments[u];s===null?s=Date.now():Date.now()-s>=p&&(s=Date.now(),a.cancel()),a(...h)};return v.cancel=a.cancel,v}},92266:function(x,t,e){"use strict";e.d(t,{C:function(){return p},Z:function(){return s}});var n=e(53360),m=e(7829),r=e(62222);const p=(0,n.forwardRef)((a,v)=>{const w=a,{prefixCls:I,className:h,style:u,checked:c,disabled:d,defaultChecked:l=!1,type:f="checkbox",title:i,onChange:o,_getCheckedValue:P}=w,E=Ue(w,["prefixCls","className","style","checked","disabled","defaultChecked","type","title","onChange","_getCheckedValue"]),[A,g]=(0,r.R)(l,{value:c});(0,n.useEffect)(()=>{P==null||P(A)},[A]);const M=(0,m.default)(I,h,{[`${I}-checked`]:A,[`${I}-disabled`]:d}),L=J=>{d||("checked"in a||g(J.target.checked),o==null||o({target:Pe(W({},a),{checked:J.target.checked}),event:J}))};return n.createElement("span",{className:M,title:i,style:u},n.createElement("input",Pe(W({},E),{className:`${I}-input`,ref:v,onChange:L,disabled:d,checked:A,type:f})),n.createElement("span",{className:`${I}-inner`}))});p.displayName="BaseCheckbox";const s=p},40549:function(x,t,e){"use strict";e.d(t,{Z:function(){return v}});var n=e(53360),m=e(7829),r=e(64508),p=e(80703),s=e(57577);const a=(0,n.forwardRef)((I,h)=>{const u=(0,n.useContext)(s.E),g=I,{children:c,name:d,prefixCls:l}=g,f=Ue(g,["children","name","prefixCls"]),[i,o]=(0,r.Y)(f),P=(0,n.isValidElement)(c);(0,n.useImperativeHandle)(h,()=>({toggle:o}));const E=`${l||u.prefixCls}${d?`-${d}`:""}`,A=(0,m.default)([`${E}-motion`],{[`${E}-motion-${i.status}`]:i.status});return(0,p.mf)(c)?i.isMounted?c(Pe(W({},i),{className:A,toggle:o})):null:P?i.isMounted?(0,n.cloneElement)(c,{className:(0,m.default)(c.props.className,A)}):null:c});a.displayName="CSSMotion";const v=a},4814:function(x,t,e){"use strict";e.d(t,{sQ:function(){return s},t4:function(){return u},x1:function(){return v}});var n=e(37797),m=e(80703),r=e(53360),p=e(11607);const s=function(){for(var c=arguments.length,d=new Array(c),l=0;l<c;l++)d[l]=arguments[l];const f=d.filter(Boolean);return f.length<=1?f[0]:i=>{d.forEach(o=>{a(o,i)})}},a=(c,d)=>{(0,m.mf)(c)?c(d):(0,m.Kn)(c)&&"current"in c&&(c.current=d)},v=function(){for(var c=arguments.length,d=new Array(c),l=0;l<c;l++)d[l]=arguments[l];return(0,n.D)(()=>s(...d),d,(f,i)=>f.length!==i.length||f.every((o,P)=>o!==i[P]))},I=c=>{var d,l;if(!c)return!1;const f=parseInt(r.version);if(h(c)&&f>=19)return!0;const i=(0,p.isMemo)(c)?c.type.type:c.type;return!(typeof i=="function"&&!((d=i.prototype)!=null&&d.render)&&i.$$typeof!==p.ForwardRef||typeof c=="function"&&!((l=c.prototype)!=null&&l.render)&&c.$$typeof!==p.ForwardRef)};function h(c){return(0,r.isValidElement)(c)&&!(0,p.isFragment)(c)}const u=c=>h(c)&&I(c)},21299:function(x,t,e){"use strict";e.d(t,{q:function(){return r}});var n=e(53360),m=e(11607);function r(p){let s=[];return n.Children.toArray(p).forEach(a=>{a!=null&&(Array.isArray(a)?s=s.concat(r(a)):(0,n.isValidElement)(a)&&(0,m.isFragment)(a)&&a.props?s=s.concat(r(a.props.children)):s.push(a))}),s}},69203:function(x,t,e){"use strict";e.d(t,{b:function(){return o}});var n=e(27833),m=e(53360),r=e(7829),p=e(7657),s=e(23436),a=e(50397),v=e(58360),I=e(21925),h=e(27377),u=e(40549),c=e(57577);const d={type:"info",showIcon:!0},l={success:s.Z,info:a.Z,error:v.Z,warning:I.Z},f=(0,m.forwardRef)((E,A)=>{const g=(0,n.c)(38),{prefixCls:M,componentConfig:L}=(0,m.useContext)(c.E),{className:w,style:J,title:k,description:ne,type:N,closable:O,showIcon:Z,action:$,icon:X,onClose:G}=(0,p.S)(E,d,L==null?void 0:L.Alert),j=(0,m.useRef)(null);let te;g[0]!==X||g[1]!==N?(te=()=>(0,m.isValidElement)(X)?X:N?(0,m.createElement)(l[N]):null,g[0]=X,g[1]=N,g[2]=te):te=g[2];const R=te,S=`${M}-alert`,B=`${M}-alert-${N}`;let z;g[3]!==w||g[4]!==S||g[5]!==B?(z=(0,r.default)(S,B,w),g[3]=w,g[4]=S,g[5]=B,g[6]=z):z=g[6];const H=z;let he;g[7]!==G?(he=ge=>{var be;(be=j.current)==null||be.toggle(),G==null||G(ge)},g[7]=G,g[8]=he):he=g[8];const V=he;let de;g[9]!==M||g[10]!==R||g[11]!==Z?(de=Z&&m.createElement("div",{className:`${M}-alert-icon`},R()),g[9]=M,g[10]=R,g[11]=Z,g[12]=de):de=g[12];const pe=`${M}-alert-content`;let D;g[13]!==M||g[14]!==k?(D=!!k&&m.createElement("div",{className:`${M}-alert-title`},k),g[13]=M,g[14]=k,g[15]=D):D=g[15];const T=`${M}-alert-description`;let q;g[16]!==ne||g[17]!==T?(q=m.createElement("div",{className:T},ne),g[16]=ne,g[17]=T,g[18]=q):q=g[18];let b;g[19]!==pe||g[20]!==D||g[21]!==q?(b=m.createElement("div",{className:pe},D,q),g[19]=pe,g[20]=D,g[21]=q,g[22]=b):b=g[22];let ve;g[23]!==$||g[24]!==M?(ve=$&&m.createElement("div",{className:`${M}-alert-action`},$),g[23]=$,g[24]=M,g[25]=ve):ve=g[25];let Ee;g[26]!==O||g[27]!==V||g[28]!==M?(Ee=O&&m.createElement("button",{className:`${M}-alert-close`,onClick:V},m.createElement(h.Z,null)),g[26]=O,g[27]=V,g[28]=M,g[29]=Ee):Ee=g[29];let _;return g[30]!==H||g[31]!==A||g[32]!==J||g[33]!==b||g[34]!==ve||g[35]!==Ee||g[36]!==de?(_=m.createElement(u.Z,{ref:j,timeout:200,name:"alert",unmountOnExit:!0,initialEntered:!0},m.createElement("div",{role:"alert",className:H,style:J,ref:A},de,b,ve,Ee)),g[30]=H,g[31]=A,g[32]=J,g[33]=b,g[34]=ve,g[35]=Ee,g[36]=de,g[37]=_):_=g[37],_});f.displayName="Alert";const o=f,P=null},60884:function(x,t,e){"use strict";e.d(t,{z:function(){return h}});var n=e(53360),m=e(7829),r=e(60333),p=e(7657),s=e(57577);const a={type:"default",variant:"default",htmlType:"button"},v=(0,n.forwardRef)((c,d)=>{const{prefixCls:l,size:f="md",componentConfig:i}=(0,n.useContext)(s.E),R=(0,p.S)(c,a,i==null?void 0:i.Button),{children:P,type:E,size:A=f,htmlType:g,status:M,loading:L,disabled:w,variant:J,icon:k,href:ne,target:N,onClick:O,anchorProps:Z={}}=R,$=Ue(R,["children","type","size","htmlType","status","loading","disabled","variant","icon","href","target","onClick","anchorProps"]),X=L?n.createElement(r.Z,{spin:L}):k,G=ne?"link":E,j=(0,m.default)(`${l}-btn`,`${l}-btn-${G}`,{[`${l}-btn-size-${A}`]:A,[`${l}-btn-status-${M}`]:!!M,[`${l}-btn-variant-${J}`]:J,[`${l}-btn-loading`]:L,[`${l}-btn-disabled`]:w}),te=S=>{if(L||w)return void S.preventDefault();O==null||O(S)};return ne?n.createElement("a",Pe(W({},Z),{href:ne,target:N,className:j,onClick:te,ref:d}),X,n.createElement("span",null,P)):n.createElement("button",Pe(W({},$),{type:g,className:j,onClick:te,ref:d}),X,n.createElement("span",null,P))});v.displayName="Button";const h=v,u=null},67824:function(x,t,e){"use strict";e.d(t,{Z:function(){return d}});var n=e(53360),m=e(7829),r=e(7657),p=e(45844),s=e(80703),a=e(92266),v=e(4814),I=e(57577),h=e(81372);const u={defaultChecked:!1,indeterminate:!1},c=(0,n.forwardRef)((l,f)=>{const{prefixCls:i,componentConfig:o}=(0,n.useContext)(I.E),P=(0,n.useContext)(h.w),G=(0,r.S)(l,u,o==null?void 0:o.Checkbox),{children:E,style:A,className:g,indeterminate:M}=G,L=Ue(G,["children","style","className","indeterminate"]),[w,J]=(0,n.useState)(!1),k="disabled"in L?L.disabled:P.disabled,ne=(0,p.D)(L.value),N=(0,n.useRef)(null);(0,n.useEffect)(()=>{var j;(j=P.registerValue)==null||j.call(P,L.value)},[]),(0,n.useEffect)(()=>{if(L.value!==ne.current){var j,te;(j=P.unregisterValue)==null||j.call(P,ne.current),(te=P.registerValue)==null||te.call(P,L.value)}return()=>{var R;return(R=P.unregisterValue)==null?void 0:R.call(P,L.value)}},[L.value]),(0,n.useEffect)(()=>{N.current&&(N.current.indeterminate=M)},[M]);const O=W({},L);(0,s.Qr)(P)||(O.onChange=function(){for(var j=arguments.length,te=new Array(j),R=0;R<j;R++)te[R]=arguments[R];var S,B;(S=L.onChange)==null||S.call(L,...te),(B=P.toggleOption)==null||B.call(P,L.value)},O.name=P.name,O.checked=P.value.includes(L.value));const Z=(0,m.default)(`${i}-checkbox-wrapper`,{[`${i}-checkbox-wrapper-checked`]:O.checked,[`${i}-checkbox-wrapper-disabled`]:k},g),$=j=>{if((0,s.mf)(E)){var te;j.preventDefault(),(te=N.current)==null||te.click()}},X=()=>(0,s.o8)(E)?null:(0,s.mf)(E)?E({checked:"checked"in O?!!O.checked:w}):n.createElement("span",{className:`${i}-checkbox-label`},E);return n.createElement("label",{className:Z,onClick:$},n.createElement(a.C,Pe(W({},O),{type:"checkbox",ref:(0,v.sQ)(f,N),disabled:k,prefixCls:`${i}-checkbox`,className:(0,m.default)({[`${i}-checkbox-indeterminate`]:M}),style:Pe(W({},A),{display:(0,s.mf)(E)?"none":void 0}),_getCheckedValue:J})),X())});c.displayName="Checkbox";const d=c},56104:function(x,t,e){"use strict";e.d(t,{Z:function(){return u}});var n=e(53360),m=e(7829),r=e(7657),p=e(80703),s=e(57577),a=e(81372),v=e(67824);const I={},h=(0,n.forwardRef)((c,d)=>{const{prefixCls:l,componentConfig:f}=(0,n.useContext)(s.E),i=(0,n.useId)(),S=(0,r.S)(c,I,f==null?void 0:f.CheckboxGroup),{defaultValue:o,children:P,options:E,className:A,style:g,disabled:M,name:L=i,onChange:w,renderOption:J}=S,k=Ue(S,["defaultValue","children","options","className","style","disabled","name","onChange","renderOption"]),[ne,N]=(0,n.useState)(k.value||o||[]),[O,Z]=(0,n.useState)([]);(0,n.useEffect)(()=>{"value"in k&&N(k.value||[])},[k.value]);const $=(0,n.useCallback)(B=>{Z(z=>[...z,B])},[]),X=(0,n.useCallback)(B=>{Z(z=>z.filter(H=>H!==B))},[]),G=(0,n.useMemo)(()=>E==null?void 0:E.map(B=>(0,p.HD)(B)||(0,p.hj)(B)?{label:B,value:B}:B),[E]),j=(0,n.useCallback)(B=>{const z=[...ne],H=ne.indexOf(B);H===-1?z.push(B):z.splice(H,1),"value"in k||N(z);const he=z.filter(V=>O.includes(V));w==null||w(he)},[ne,O,k,w]);let te=P;if((0,p.kJ)(G)&&G.length>0){const B=(0,p.mf)(J);te=G.map(z=>{const H=ne.includes(z.value),he=B?()=>J(Pe(W({},z),{checked:H})):z.label;return n.createElement(v.Z,{key:`checkbox-group-options-${z.value}`,className:z.className,style:z.style,disabled:"disabled"in z?z.disabled:M,value:z.value,checked:H,id:z.id,title:z.title,onChange:z.onChange},he)})}const R=(0,n.useMemo)(()=>({name:L,value:ne,disabled:M,toggleOption:j,registerValue:$,unregisterValue:X}),[L,ne,M,j,$,X]);return n.createElement("div",{className:(0,m.default)(`${l}-checkbox-group`,A),style:g,ref:d},n.createElement(a.w.Provider,{value:R},te))});h.displayName="CheckboxGroup";const u=h},81372:function(x,t,e){"use strict";e.d(t,{w:function(){return m}});var n=e(53360);const m=(0,n.createContext)({})},89946:function(x,t,e){"use strict";e.r(t),e.d(t,{Checkbox:function(){return v},CheckboxGroup:function(){return I},default:function(){return h}});var n=e(67824),m=e(56104),r=e(558),p=e.n(r),s={};for(var a in r)["default","Checkbox","CheckboxGroup"].indexOf(a)<0&&(s[a]=function(u){return r[u]}.bind(0,a));e.d(t,s);const v=n.Z;v.Group=m.Z;const I=v.Group,h=v},558:function(){},57577:function(x,t,e){"use strict";e.d(t,{$:function(){return m},E:function(){return r}});var n=e(53360);const m={componentConfig:{},prefixCls:"sqi",iconPrefix:"sqi"},r=(0,n.createContext)(m)},83405:function(x,t,e){"use strict";e.d(t,{i:function(){return I}});var n=e(27833),m=e(53360),r=e(12598),p=e(7657),s=e(31136),a=e(57577);function v(h){const u=(0,n.c)(11),c=(0,p.S)(h,a.$),{iconPrefix:d,children:l}=c;let f;u[0]!==c?(f=(0,r.C)(c,["children","iconPrefix"]),u[0]=c,u[1]=f):f=u[1];const i=f,o=d?s.Z.Provider:m.Fragment;let P;u[2]!==d?(P={prefixCls:d},u[2]=d,u[3]=P):P=u[3];let E;u[4]!==o||u[5]!==l||u[6]!==P?(E=m.createElement(o,{value:P},l),u[4]=o,u[5]=l,u[6]=P,u[7]=E):E=u[7];let A;return u[8]!==i||u[9]!==E?(A=m.createElement(a.E.Provider,{value:i},E),u[8]=i,u[9]=E,u[10]=A):A=u[10],A}v.displayName="ConfigProvider";const I=v},48380:function(x,t,e){"use strict";e.d(t,{i:function(){return I}});var n=e(53360),m=e(7829),r=e(7657),p=e(57577);const s={direction:"horizontal",align:"center"},a=(0,n.forwardRef)((u,c)=>{const{prefixCls:d,componentConfig:l}=(0,n.useContext)(p.E),f=(0,r.S)(u,s,l==null?void 0:l.Divider),{direction:i,align:o,dashed:P,className:E,children:A,text:g,style:M}=f,L=A||g,w=i!=="vertical"&&!!L,J=(0,m.default)(`${d}-divider`,{[`${d}-divider-${i}`]:i,[`${d}-divider-with-text`]:w,[`${d}-divider-with-text-${o}`]:w,[`${d}-divider-dashed`]:!!P,className:E});return n.createElement("div",{className:J,style:M,ref:c},w&&n.createElement("span",{className:`${d}-divider-inner-text`},L))});a.displayName="Divider";const I=a,h=null},17599:function(x,t,e){"use strict";e.d(t,{J:function(){return ne},X:function(){return k}});var n=e(53360),m=e(7829),r=e(7657),p=e(80703),s=e(57577);const a=["xxl","xl","lg","md","sm","xs"],v={xs:"(max-width: 575px)",sm:"(min-width: 576px)",md:"(min-width: 768px)",lg:"(min-width: 992px)",xl:"(min-width: 1200px)",xxl:"(min-width: 1600px)"},I=Object.keys(v),h=new Map;let u=-1,c={};const l={handlers:{},dispatch(N){return c=N,h.forEach(O=>O(c)),h.size>=1},subscribe(N){return h.size||this.register(),u+=1,h.set(u,N),N(c),u},unsubscribe(N){h.delete(N),h.size||this.unregister()},register(){I.forEach(N=>{const O=X=>{let{matches:G}=X;this.dispatch(Pe(W({},c),{[N]:G}))},Z=v[N],$=window.matchMedia(Z);$.addListener(O),this.handlers[Z]={mql:$,listener:O},O($)})},unregister(){I.forEach(N=>{const O=v[N],Z=this.handlers[O];Z==null||Z.mql.removeListener(Z==null?void 0:Z.listener)}),h.clear()}},i=(0,n.createContext)({}),o={gutter:0,align:"start",justify:"start",wrap:!0},P=(0,n.forwardRef)((N,O)=>{const{prefixCls:Z,componentConfig:$}=(0,n.useContext)(s.E),_=(0,r.S)(N,o,$==null?void 0:$.Row),{align:X,justify:G,gutter:j,className:te,wrap:R,children:S,style:B}=_,z=Ue(_,["align","justify","gutter","className","wrap","children","style"]),[H,he]=(0,n.useState)({xs:!1,sm:!1,md:!1,lg:!1,xl:!1,xxl:!1});(0,n.useEffect)(()=>{const ge=l.subscribe(be=>{((0,p.Kn)(j)||(0,p.kJ)(j)&&((0,p.Kn)(j[0])||(0,p.Kn)(j[1])))&&he(be)});return()=>l.unsubscribe(ge)},[]);const V=de();function de(){const ge=[void 0,void 0];return((0,p.kJ)(j)?j:[j,void 0]).forEach((C,F)=>{if((0,p.Kn)(C))for(let y=0;y<a.length;y++){const oe=a[y];if(H[oe]&&C[oe]!==void 0){ge[F]=C[oe];break}}else ge[F]=C}),ge}const pe=(0,m.default)(`${Z}-row`,{[`${Z}-row-nowrap`]:R===!1,[`${Z}-row-align-${X}`]:X,[`${Z}-row-justify-${G}`]:G},te),[D,T]=V,q=(0,n.useMemo)(()=>({gutter:[D,T],wrap:R}),[D,T,R]),b={},ve=(0,p.hj)(D)&&D!==0,Ee=(0,p.hj)(T)&&T!==0;if(ve||Ee){const ge=-D/2,be=-T/2;ge&&(b.marginLeft=ge,b.marginRight=ge),be&&(b.marginTop=be,b.marginBottom=be)}return n.createElement(i.Provider,{value:q},n.createElement("div",Pe(W({},z),{ref:O,className:pe,style:W(W({},B),b)}),S))});P.displayName="Row";const E=P,A={offset:0};function g(N){return(0,p.hj)(N)?`${N} ${N} auto`:/^\d+(\.\d+)?(px|em|rem|%)$/.test(N)?`0 0 ${N}`:N}const M=["xs","sm","md","lg","xl","xxl"],L=(N,O)=>{let Z={};return M.forEach($=>{const X=N[$];if(!X)return;let G={};(0,p.hj)(X)?G.span=X:(0,p.Kn)(X)&&(G=X),Z=Pe(W({},Z),{[`${O}-col-${$}-${G.span}`]:(0,p.hj)(G.span),[`${O}-col-${$}-order-${G.order}`]:G.order,[`${O}-col-${$}-offset-${G.offset}`]:G.offset})}),Z},w=(0,n.forwardRef)((N,O)=>{const{componentConfig:Z,prefixCls:$}=(0,n.useContext)(s.E),{gutter:X}=(0,n.useContext)(i),_=(0,r.S)(N,A,Z==null?void 0:Z.Col),{span:G,offset:j,children:te,className:R,style:S,flex:B,order:z,xs:H,sm:he,md:V,lg:de,xl:pe,xxl:D}=_,T=Ue(_,["span","offset","children","className","style","flex","order","xs","sm","md","lg","xl","xxl"]),q=L({xs:H,sm:he,md:V,lg:de,xl:pe,xxl:D},$),b=(0,m.default)(`${$}-col`,{[`${$}-col-${G}`]:(0,p.hj)(G),[`${$}-col-offset-${j}`]:j,[`${$}-col-order-${z}`]:z},q,R),ve={};if(X){const ge=X[0]?X[0]/2:0,be=X[1]?X[1]/2:0;ge&&(ve.paddingLeft=ge,ve.paddingRight=ge),be&&(ve.paddingTop=be,ve.paddingBottom=be)}const Ee={};return B&&(Ee.flex=g(B)),n.createElement("div",Pe(W({ref:O},T),{className:b,style:W(W(W({},S),Ee),ve)}),te)});w.displayName="Col";const J=w,k=E,ne=J},45990:function(x,t,e){"use strict";e.r(t),e.d(t,{Alert:function(){return n.b},Button:function(){return m.z},Col:function(){return v.J},ConfigProvider:function(){return s.i},Divider:function(){return a.i},Input:function(){return I.I},Row:function(){return v.X},Space:function(){return u.T},Switch:function(){return c.r}});var n=e(69203),m=e(60884),r=e(89946),l={};for(var p in r)["default","Alert","Button"].indexOf(p)<0&&(l[p]=function(f){return r[f]}.bind(0,p));e.d(t,l);var s=e(83405),a=e(48380),v=e(17599),I=e(38312),h=e(37663),l={};for(var p in h)["default","Alert","Button","Checkbox","CheckboxGroup","ConfigProvider","Divider","Col","Row","Input"].indexOf(p)<0&&(l[p]=function(i){return h[i]}.bind(0,p));e.d(t,l);var u=e(92595),c=e(9090),d=e(36112),l={};for(var p in d)["default","Alert","Button","Checkbox","CheckboxGroup","ConfigProvider","Divider","Col","Row","Input","Radio","RadioButton","RadioGroup","Space","Switch"].indexOf(p)<0&&(l[p]=function(i){return d[i]}.bind(0,p));e.d(t,l)},38312:function(x,t,e){"use strict";e.d(t,{I:function(){return f}});var n=e(53360),m=e(7829),r=e(7657),p=e(62222),s=e(80703),a=e(58360),v=e(85569),I=e(1824),h=e(57577);const u={type:"text",size:"md",align:"left",visibilityToggle:!0};function c(o,P,E){let A;return A=o===null||(0,s.o8)(o)||(0,s.HD)(o)?o||"":String(o),(0,s.hj)(P)&&!E?A.slice(0,P):A}const d=(0,n.forwardRef)((o,P)=>{const{prefixCls:E,componentConfig:A}=(0,n.useContext)(h.E),Ze=(0,r.S)(o,u,A==null?void 0:A.Input),{size:g,status:M,align:L,disabled:w,allowClear:J,placeholder:k,variant:ne="outline",addonBefore:N,addonAfter:O,prefix:Z,suffix:$,value:X,defaultValue:G,type:j,className:te,style:R,readOnly:S,visibilityToggle:B,maxLength:z,tips:H,onFocus:he,onBlur:V,onChange:de}=Ze,pe=Ue(Ze,["size","status","align","disabled","allowClear","placeholder","variant","addonBefore","addonAfter","prefix","suffix","value","defaultValue","type","className","style","readOnly","visibilityToggle","maxLength","tips","onFocus","onBlur","onChange"]),D=(0,n.useRef)(null),T=(0,n.useRef)(null);(0,n.useImperativeHandle)(P,()=>({currentElement:D.current,inputElement:T.current,focus:()=>{var ie;return(ie=T.current)==null?void 0:ie.focus()},blur:()=>{var ie;return(ie=T.current)==null?void 0:ie.blur()},select:()=>{var ie;return(ie=T.current)==null?void 0:ie.select()}}));const[q,b]=(0,n.useState)(!1),ve=ie=>{w||S||(b(!0),he==null||he(ie))},Ee=ie=>{w||S||(b(!1),V==null||V(ie))},_=(0,s.hj)(z)?z:z==null?void 0:z.length,ge=(0,s.hj)(z)?!1:z==null?void 0:z.errorOnly,be=(0,s.hj)(z)?!0:(z==null?void 0:z.showLimit)!==!1,[C,F]=(0,p.R)(G,{value:X}),y=c(C,_,ge),oe=(0,s.hj)(_)?y.length>_:!1,re=ie=>{const{value:Se}=ie.target;F(Se),de==null||de(Se,ie)},ue=()=>{var ie;w||(ie=T.current)==null||ie.focus()},ce=(0,m.default)(`${E}-input`,{[`${E}-input-variant-${ne}`]:ne,[`${E}-input-size-${g}`]:g,[`${E}-input-disabled`]:w,[`${E}-input-align-${L}`]:L,[`${E}-input-status-${M}`]:M,[`${E}-input-focus`]:q,[`${E}-input-limit-length-error`]:oe},te),Q=(0,m.default)(`${E}-input-real`),Ie=J&&y&&!w,U=n.createElement(a.Z,null),me=ie=>{ie.stopPropagation(),F(""),de==null||de("",ie)},Y=Ie&&n.createElement("button",{type:"button",tabIndex:-1,className:(0,m.default)(`${E}-input-suffix`,`${E}-input-clear`),onClick:me},U),K=(0,s.Kn)(B)&&!(0,s.o8)(B.visible),[De,Be]=(0,n.useState)(j);(0,n.useEffect)(()=>{Be(K?B.visible?"text":"password":j)},[j,K,B==null?void 0:B.visible]);const ae=()=>{if(w)return;const ie=De==="password"?"text":"password";if(Be(ie),K){var Se;(Se=B.onVisibleChange)==null||Se.call(B,ie==="text")}},xe=j==="password",ee=(0,n.useMemo)(()=>xe?(0,s.Kn)(B)&&(0,s.mf)(B.renderIcon)?B.renderIcon(De==="text"):De==="password"?n.createElement(v.Z,null):De==="text"?n.createElement(I.Z,null):null:$,[xe,De,B,$]),le=(0,n.useMemo)(()=>function(ie){let{children:Se}=ie;const Me=N||O;let ye=Se;return Me&&(ye=n.createElement("div",{ref:D,className:`${E}-input-group`},ye)),H&&(ye=n.createElement("div",{ref:D,className:`${E}-input-group-extra`},ye)),ye},[N,O,H]),se=Z&&n.createElement("span",{className:`${E}-input-prefix`},Z),we=ee&&n.createElement("span",{role:"button",tabIndex:-1,className:(0,m.default)(`${E}-input-suffix`,{[`${E}-input-suffix-password`]:xe}),onClick:ae,onMouseDown:ie=>ie.preventDefault(),onMouseUp:ie=>ie.preventDefault()},ee),Ce=(0,s.hj)(_)&&be&&n.createElement("span",{className:`${E}-input-limit-length-text`},y.length,"/",_),Le=H&&n.createElement("div",{className:(0,m.default)(`${E}-input-tips`,{[`${E}-input-tips-status-${M}`]:M})},H),$e=n.createElement("span",{ref:N||O?void 0:D,className:ce,style:R,onClick:ue},se,n.createElement("input",Pe(W({ref:T},pe),{type:De,value:y,readOnly:S,className:Q,placeholder:k,disabled:w,onChange:re,onFocus:ve,onBlur:Ee})),Y,we,Ce),We=N&&n.createElement("span",{className:(0,m.default)(`${E}-input-group-addon`)},N),Oe=O&&n.createElement("span",{className:(0,m.default)(`${E}-input-group-addon`)},O);return n.createElement(le,null,We,$e,Oe,Le)});d.displayName="Input";const f=d,i=null},74052:function(x,t,e){"use strict";e.d(t,{Z:function(){return c}});var n=e(53360),m=e(7829),r=e(7657),p=e(80703),s=e(92266),a=e(4814),v=e(57577),I=e(83595);const h={defaultChecked:!1},u=(0,n.forwardRef)((d,l)=>{const{prefixCls:f,componentConfig:i}=(0,n.useContext)(v.E),o=(0,n.useContext)(I.Z),j=(0,r.S)(d,h,i==null?void 0:i.Radio),{_IS_BUTTON_:P,value:E,children:A,style:g}=j,M=Ue(j,["_IS_BUTTON_","value","children","style"]),L=te=>{var R,S;(R=M.onChange)==null||R.call(M,te),o==null||(S=o.onChange)==null||S.call(o,te)},w=W({},M);let J="md";if(!(0,p.Qr)(o)){w.name=o.name,w.onChange=L,w.checked=E===o.value;var k;w.disabled=(k=w.disabled)!=null?k:o.disabled,J=o.size?o.size:J}const[ne,N]=(0,n.useState)(!1),O=P?`${f}-radio-button`:`${f}-radio`,Z=(0,m.default)(`${O}-wrapper`,{[`${O}-wrapper-disabled`]:w.disabled,[`${O}-wrapper-checked`]:w.checked,[`${O}-wrapper-size-${J}`]:J,[`${O}-wrapper-filled`]:o.buttonVariant==="filled"}),$=()=>(0,p.o8)(A)?null:(0,p.mf)(A)?A({checked:"checked"in w?!!w.checked:ne}):n.createElement("span",{className:`${O}-label`},A),X=(0,n.useRef)(null),G=te=>{if((0,p.mf)(A)){var R;te.preventDefault(),(R=X.current)==null||R.click()}};return n.createElement("label",{className:Z,onClick:G},n.createElement(s.Z,Pe(W(W({},M),w),{ref:(0,a.sQ)(l,X),value:E,type:"radio",prefixCls:O,style:Pe(W({},g),{display:(0,p.mf)(A)?"none":void 0}),disabled:w.disabled,_getCheckedValue:N})),$())});u.displayName="Radio";const c=u},89312:function(x,t,e){"use strict";e.d(t,{Z:function(){return a}});var n=e(27833),m=e.n(n),r=e(53360),p=e(74052);const s=(0,r.forwardRef)((v,I)=>{const h=(0,n.c)(3);let u;return h[0]!==v||h[1]!==I?(u=r.createElement(p.Z,Pe(W({_IS_BUTTON_:!0},v),{ref:I})),h[0]=v,h[1]=I,h[2]=u):u=h[2],u});s.displayName="RadioButton";const a=s},59803:function(x,t,e){"use strict";e.d(t,{Z:function(){return d}});var n=e(53360),m=e(7829),r=e(7657),p=e(62222),s=e(80703),a=e(57577),v=e(83595),I=e(74052),h=e(89312);const u={disabled:!1,size:"md",appearance:"radio",buttonVariant:"outline"},c=(0,n.forwardRef)((l,f)=>{const{prefixCls:i,componentConfig:o}=(0,n.useContext)(a.E),P=(0,r.S)(l,u,o==null?void 0:o.RadioGroup),E=(0,n.useId)(),{className:A,style:g,name:M=E,value:L,defaultValue:w,children:J,disabled:k,size:ne,buttonVariant:N,renderOption:O,onChange:Z,appearance:$,options:X}=P,[G,j]=(0,p.R)(w,{value:L}),te=(0,n.useCallback)(z=>{const H=z.target.value;"value"in P||j(H),H!==G&&(Z==null||Z(z))},[G,Z]);let R=J;const S=$==="button"?h.Z:I.Z;if((0,s.kJ)(X)&&X.length>0){const z=(0,s.mf)(O);R=X.map(H=>{if((0,s.HD)(H)||(0,s.hj)(H)){const de=G===H,pe=z?()=>O({label:H,value:H,checked:de}):H;return n.createElement(S,{key:H.toString(),disabled:k,value:H,checked:de},pe)}const he=G===H.value,V=z?()=>O(Pe(W({},H),{checked:he})):H.label;return n.createElement(S,{key:`radio-group-options-${H.value}`,className:H.className,style:H.style,disabled:H.disabled||k,value:H.value,checked:he,id:H.id,title:H.title,onChange:H.onChange},V)})}const B=(0,n.useMemo)(()=>({name:M,value:G,disabled:k,size:ne,buttonVariant:N,onChange:te}),[M,L,k,ne,N,te]);return n.createElement("div",{ref:f,className:(0,m.default)(`${i}-radio-group`,A),style:g},n.createElement(v.Z.Provider,{value:B},R))});c.displayName="RadioGroup";const d=c},83595:function(x,t,e){"use strict";e.d(t,{Z:function(){return r}});var n=e(53360);const r=(0,n.createContext)({})},37663:function(x,t,e){"use strict";e.r(t),e.d(t,{Radio:function(){return I},RadioButton:function(){return u},RadioGroup:function(){return h},default:function(){return c}});var n=e(74052),m=e(89312),r=e(59803),p=e(63149),s=e.n(p),a={};for(var v in p)["default","Radio","RadioButton","RadioGroup"].indexOf(v)<0&&(a[v]=function(d){return p[d]}.bind(0,v));e.d(t,a);const I=n.Z;I.Group=r.Z,I.Button=m.Z;const h=I.Group,u=I.Button,c=I},63149:function(){},92595:function(x,t,e){"use strict";e.d(t,{T:function(){return c}});var n=e(53360),m=e(7829),r=e(80703),p=e(7657),s=e(21299),a=e(57577);const v={sm:8,md:16,lg:24},I={direction:"horizontal",align:"center",wrap:!1},h=(0,n.forwardRef)((l,f)=>{const{prefixCls:i,size:o="md",componentConfig:P}=(0,n.useContext)(a.E),G=(0,p.S)(l,I,P==null?void 0:P.Space),{className:A,children:g,size:M=o,direction:L="horizontal",align:w,split:J,wrap:k=!1}=G,ne=Ue(G,["className","children","size","direction","align","split","wrap"]),N=(0,s.q)(g),O=L==="horizontal"&&w===void 0?"center":w,Z=(0,m.default)(`${i}-space`,`${i}-space-direction-${L}`,{[`${i}-space-align-${O}`]:O,[`${i}-space-wrap`]:k},A),$=(0,n.useCallback)(j=>{const te=(0,r.kJ)(M)?M:[M,M],[R,S]=te.map(B=>(0,r.HD)(B)?v[B]:B||0);return k?{marginRight:R,marginBottom:S}:L==="vertical"?{marginBottom:S}:{marginRight:j?void 0:R}},[M]),X=N.map((j,te)=>{const R=te===N.length-1;return n.createElement(n.Fragment,{key:`space-item-${te}`},n.createElement("div",{className:"space-item",style:$(R)},j),!R&&J&&n.createElement("span",{className:"sqi-space-item-split"},J))});return n.createElement("div",Pe(W({className:Z},ne),{ref:f}),X)});h.displayName="Space";const c=h,d=null},9090:function(x,t,e){"use strict";e.d(t,{r:function(){return u}});var n=e(53360),m=e(7829),r=e(7657),p=e(62222),s=e(60333),a=e(57577);const v={label:[],loading:!1,disabled:!1},I=(0,n.forwardRef)((d,l)=>{const{prefixCls:f,size:i="md",componentConfig:o}=(0,n.useContext)(a.E),j=(0,r.S)(d,v,o==null?void 0:o.Switch),{checked:P,defaultChecked:E,className:A,disabled:g,size:M=i,label:L,loading:w,loadingIcon:J,onChange:k,onClick:ne}=j,N=Ue(j,["checked","defaultChecked","className","disabled","size","label","loading","loadingIcon","onChange","onClick"]),[O,Z]=(0,p.R)(!1,{value:P,defaultValue:E});function $(te){if(g||w)return;const R=!O;Z(R),k==null||k(R,te),ne==null||ne(R,te)}const X=(0,m.default)(`${f}-switch`,{[`${f}-switch-checked`]:O,[`${f}-switch-disabled`]:g,[`${f}-switch-loading`]:w,[`${f}-switch-${M}`]:M},A),G=J||n.createElement(s.Z,{spin:!0});return n.createElement("button",Pe(W({},N),{type:"button",role:"switch","aria-checked":O,ref:l,className:X,disabled:g||w,onClick:$}),n.createElement("div",{className:`${f}-switch-handle`},w&&G),n.createElement("div",{className:`${f}-switch-content`},O?L[0]:L[1]))});I.displayName="Switch";const u=I,c=null},67171:function(x,t,e){"use strict";e.d(t,{Z:function(){return be}});var n=e(53360),m=e(7829),r=e(7657),p=e(62222),s=e(60164),a=e(6890),v=e(8240),I=e(21299);function h(C){return C instanceof HTMLElement||C instanceof SVGElement}function u(C){return C&&typeof C=="object"&&h(C.nativeElement)?C.nativeElement:h(C)?C:null}function c(C){if(C)return C.current&&typeof C.current=="object"&&"currentElement"in C.current?C.current.currentElement:C.current}function d(C){if(!(C&&(0,n.isValidElement)(C)))return null;if(parseInt(n.version)>=19){var y;return((y=C.props)==null?void 0:y.ref)||null}return C.ref}var l=e(4814);const f=(0,n.forwardRef)((C,F)=>{const{children:y,disabled:oe,throttleMs:re=100,onResize:ue}=C,ce=(0,n.isValidElement)(y),Q=ce?(0,I.q)(y):[],Ie=ce?d(y):null,U=(0,n.useRef)(null),me=(0,l.x1)(Ie,U),Y=()=>c(U);(0,n.useImperativeHandle)(F,()=>Y());const K=ue?(0,a.P)(ue,re):void 0;return(0,v.y)(Y(),K,!oe),ce?(0,n.cloneElement)(y,{ref:me}):y});f.displayName="ResizeObserverComponent";const i=f;var o=e(27833),P=e(86752),E=e(34028),A=e(80703);const g=(0,E.J)();function M(C){return g?(0,A.HD)(C)?document.querySelector(C):(0,A.mf)(C)?C():C instanceof HTMLElement?C:document.body:null}const L=(0,n.forwardRef)((C,F)=>{const y=(0,o.c)(25),{getContainer:oe,prefixCls:re,children:ue,open:ce,rootStyle:Q}=C,Ie=ce===void 0?!0:ce,[U,me]=(0,n.useState)(null),[Y,K]=(0,n.useState)(null),De=Y||document.body;let Be,ae;y[0]!==oe?(Be=()=>{const Oe=M(oe);K(Oe||null)},ae=[oe],y[0]=oe,y[1]=Be,y[2]=ae):(Be=y[1],ae=y[2]),(0,n.useEffect)(Be,ae);let xe;y[3]!==U||y[4]!==re||y[5]!==Q?(xe=()=>{if(!g||U)return null;const Oe=document.createElement("div");re&&(Oe.className=`${re}-portal-wrapper`),Q&&Object.assign(Oe.style,Q),Oe.setAttribute("data-portal","true"),me(Oe)},y[3]=U,y[4]=re,y[5]=Q,y[6]=xe):xe=y[6];const ee=xe;let le;y[7]!==ee||y[8]!==Ie?(le=()=>{g&&(Ie?ee():me(null))},y[7]=ee,y[8]=Ie,y[9]=le):le=y[9];let se;y[10]!==Ie?(se=[Ie],y[10]=Ie,y[11]=se):se=y[11],(0,s.L)(le,se);let we,Ce;y[12]!==U?(we=()=>U,Ce=[U],y[12]=U,y[13]=we,y[14]=Ce):(we=y[13],Ce=y[14]),(0,n.useImperativeHandle)(F,we,Ce);let Le;y[15]!==U||y[16]!==De||y[17]!==Ie?(Le=()=>{if(!g||!U)return;const Oe=()=>!U.parentNode&&De.appendChild(U),Ze=()=>{var ie;return(ie=U.parentNode)==null?void 0:ie.removeChild(U)};return Ie?Oe():Ze(),()=>{Ze()}},y[15]=U,y[16]=De,y[17]=Ie,y[18]=Le):Le=y[18];let $e;if(y[19]!==U||y[20]!==Ie?($e=[Ie,U],y[19]=U,y[20]=Ie,y[21]=$e):$e=y[21],(0,s.L)(Le,$e),!(Ie&&ue))return null;let We;return y[22]!==ue||y[23]!==U?(We=U?(0,P.createPortal)(ue,U):null,y[22]=ue,y[23]=U,y[24]=We):We=y[24],We});L.displayName="Portal";const w=L;var J=e(40549),k=e(57577);const ne="Escape",O=C=>{const{trigger:F,delay:y,disabled:oe,visible:re,clickOutsideClose:ue,triggerEl:ce,onVisibleChange:Q}=C,Ie=(0,n.useRef)(!1),U=(0,n.useRef)(!1),me=(0,n.useRef)(null),Y=(0,n.useRef)(0);(0,n.useEffect)(()=>{if(oe)return;const ae=xe=>{var ee;!(ce==null||(ee=ce.contains)==null)&&ee.call(ce,xe.target)||Ie.current||re&&ue&&(Q==null||Q(!1,{e:xe,trigger:"document"}))};return document.addEventListener("mousedown",ae),document.addEventListener("touchend",ae),()=>{document.removeEventListener("mousedown",ae),document.removeEventListener("touchend",ae)}},[oe,re,ce]);function K(ae){y?(clearTimeout(me.current),me.current=setTimeout(ae,y)):ae()}function De(){return oe?{}:{onMouseEnter:ae=>{F==="hover"&&!U.current&&(clearTimeout(me.current),Q==null||Q(!0,{e:ae,trigger:"hover"}))},onMouseLeave:ae=>{F==="hover"&&(U.current=!0,clearTimeout(me.current),Q==null||Q(!1,{e:ae,trigger:"hover"}))},onMouseDown:()=>{clearTimeout(Y.current),Ie.current=!0,Y.current=window.setTimeout(()=>{Ie.current=!1})},onTouchEnd:()=>{clearTimeout(Y.current),Ie.current=!0,Y.current=window.setTimeout(()=>{Ie.current=!1})}}}function Be(ae){return oe?{}:{onMouseDown:ee=>{var le,se;F==="mousedown"&&K(()=>Q==null?void 0:Q(!re,{e:ee,trigger:"mousedown"})),(le=(se=ae.props).onMouseDown)==null||le.call(se,ee)},onClick:ee=>{var le,se;F==="click"&&(ee.preventDefault(),ee.stopPropagation(),K(()=>Q==null?void 0:Q(!re,{e:ee,trigger:"click"}))),(le=(se=ae.props).onClick)==null||le.call(se,ee)},onTouchStart:ee=>{var le,se;(F==="hover"||F==="mousedown")&&(U.current=!1,K(()=>Q==null?void 0:Q(!0,{e:ee,trigger:"hover"}))),(le=(se=ae.props).onTouchStart)==null||le.call(se,ee)},onMouseEnter:ee=>{var le,se;F==="hover"&&(U.current=!1,K(()=>Q==null?void 0:Q(!0,{e:ee,trigger:"hover"}))),(le=(se=ae.props).onMouseEnter)==null||le.call(se,ee)},onMouseLeave:ee=>{var le,se;F==="hover"&&(U.current=!1,K(()=>Q==null?void 0:Q(!1,{e:ee,trigger:"hover"}))),(le=(se=ae.props).onMouseLeave)==null||le.call(se,ee)},onFocus:ee=>{var le,se;F==="focus"&&K(()=>Q==null?void 0:Q(!0,{e:ee,trigger:"focus"})),(le=(se=ae.props).onFocus)==null||le.call(se,ee)},onBlur:ee=>{var le,se;F==="focus"&&K(()=>Q==null?void 0:Q(!1,{e:ee,trigger:"blur"})),(le=(se=ae.props).onBlur)==null||le.call(se,ee)},onContextMenu:ee=>{var le,se;F==="context-menu"&&(ee.preventDefault(),K(()=>Q==null?void 0:Q(!0,{e:ee,trigger:"context-menu"}))),(le=(se=ae.props).onContextMenu)==null||le.call(se,ee)},onKeyDown:ee=>{var le,se;(ee==null?void 0:ee.key)===ne&&K(()=>Q==null?void 0:Q(!1,{e:ee,trigger:"keydown-esc"})),(le=(se=ae.props).onKeyDown)==null||le.call(se,ee)}}}return{genPopupProps:De,genTriggerProps:Be}};function Z(C,F,y){const{top:oe,left:re,width:ue,height:ce}=C.getBoundingClientRect(),Q=oe+y,Ie=re+F;return{width:ue,height:ce,top:Q,bottom:Q+ce,left:Ie,right:Ie+ue}}function $(C,F,y){const oe=Z(C,F,y),re=C.clientWidth,ue=C.clientHeight,ce=oe.left+C.clientLeft,Q=oe.top+C.clientTop;return{width:re,height:ue,top:Q,bottom:Q+ue,left:ce,right:ce+re}}function X(C){if(!C||C.tagName==="HTML")return;const F=window.getComputedStyle(C),y=oe=>["auto","scroll"].includes(oe);return C.clientHeight<C.scrollHeight&&y(F.overflowX)||C.clientWidth<C.scrollWidth&&y(F.overflowY)?C:X(C.parentNode)}function G(C,F){return Math.round(Math.abs(C))>Math.round(Math.abs(F))?C:F}const j=(C,F)=>`translate3d(${C}px, ${F}px, 0)`;function te(C){if(!C)return[0,0];const F=window.getComputedStyle(C),y=F.transform||F.webkitTransform||"none";if(y==="none")return[0,0];if(y.match(/matrix\(([^)]+)\)/)){var oe,re;const Q=((re=y.match(/matrix\((.+)\)/))==null||(oe=re[1])==null?void 0:oe.split(",").map(Number))||[0,0];if(Q.length===6)return[Q[4],Q[5]]}const[,ue=0,ce=0]=(y.match(/translate\((.*?)px,\s(.*?)px\)/)||[]).map(Q=>Number(Q));return[ue,ce]}function R(C){const F=C.split("-"),y=F[0],oe=F[1];let re;const ue=y==="top"||y==="bottom",ce=y==="left"||y==="right";return ue&&(oe==="start"&&(re="left"),oe==="end"&&(re="right")),ce&&(oe==="start"&&(re="top"),oe==="end"&&(re="bottom")),[y,re,ue,ce]}function S(C){return C?(0,A.Kn)(C)?[C.x||0,C.y||0]:[C||0,C||0]:[0,0]}const B={direction:"bottom",enableFlip:!0,enableShift:!0};function z(C,F){const{reference:y,popper:oe,arrow:re}=C;if(!y||!oe)return;const ue=W(W({},B),F),ce=oe.parentNode,[Q,Ie]=te(ce),U=window.pageYOffset,me=window.pageXOffset,Y=Z(y,me,U),K=Z(oe,me,U),De=Y.width-K.width,Be=Y.height-K.height;let ae=Y.left-K.left+Q,xe=Y.top-K.top+Ie;const[ee,le,se,we]=R(ue.direction);let Ce=ee;const Le=le==="left"?0:le==="right"?De:De/2,$e=De-Le,We=le==="top"?0:le==="bottom"?Be:Be/2,Oe=Be-We;se&&(ae+=Le,xe+=ee==="top"?-K.height:Y.height),we&&(ae+=ee==="left"?-K.width:Y.width,xe+=We);let Ze=X(y);const[ie,Se]=S(ue.offset),{height:Me=0,width:ye=0}=re?Z(re,me,U):{};let Ke=0,ze=0;for(;Ze;){const Re=$(Ze,me,U);Fe(Re),Ze=X(Ze.parentNode)}const{clientHeight:Ye,clientWidth:Ge}=document.documentElement;Fe({top:U,bottom:U+Ye,left:me,right:me+Ge,height:Ye,width:Ge}),ae-=Ke,xe-=ze,Je(),se&&(xe+=Ce==="bottom"?Se:-Se),we&&(ae+=Ce==="right"?ie:-ie),ce.style.transform=j(ae,xe),ce.setAttribute("data-direction",Ce);function Fe(Re){const{top:fe,bottom:je,left:Ne,right:Ve,height:ke,width:nn}=Re;if(se){const Te=Math.round(Y.top-fe+Y.height/2),Ae=Math.round(ke/2);ue.enableFlip&&tn(Te,Ae),ue.enableShift&&on()}if(we){const Te=Math.round(Y.left-Ne+Y.width/2),Ae=Math.round(nn/2);ue.enableFlip&&an(Te,Ae),ue.enableShift&&rn()}function tn(Te,Ae){const Xe=Y.top-(K.height+Se+Me)<fe,Qe=Y.bottom+K.height+Se+Me>ke+fe;Xe&&Te<=Ae&&Ce==="top"?(xe+=K.height+Y.height,Ce="bottom"):Qe&&Te>=Ae&&Ce==="bottom"&&(xe-=K.height+Y.height,Ce="top")}function on(){if(Y.left+Le<Ne){const Te=Y.left+Le-Ne,Ae=Y.right-ye>Ne?Te:-Y.width+Le+ye;Ke=G(Ae,Ke)}if(Y.right-$e>Ve){const Te=Y.right-$e-Ve,Ae=Y.left+ye<Ve?Te:Y.width-$e-ye;Ke=G(Ae,Ke)}}function an(Te,Ae){const Xe=Y.left-(K.width+ie+ye)<Ne,Qe=Y.right+K.width+ie+ye>Ve;Xe&&Te<Ae&&Ce==="left"?(ae+=Y.width+K.width,Ce="right"):Qe&&Te>Ae&&Ce==="right"&&(ae-=Y.width+K.width,Ce="left")}function rn(){if(Y.top+We<fe){const Te=Y.top+We-fe,Ae=Y.bottom-Me>fe?Te:-Y.height+We+Me;ze=G(Ae,ze)}if(Y.bottom-Oe>je){const Te=Y.bottom-Oe-je,Ae=Y.top+Me<je?Te:Y.height-Oe-Me;ze=G(Ae,ze)}}}function Je(){if(!re)return;se?xe+=Ce==="bottom"?Me:-Me:we&&(ae+=Ce==="right"?ye:-ye);const Re=ue.direction.split("-")[1]||"center",fe={x:0,y:0};if(se){fe.y=Ce==="top"?K.height:-Me;const je=Math.abs(Y.width-K.width)>Math.abs(Ke),Ne=Ke===0;Re==="start"?Ne?fe.x=0:fe.x=Math.min(Math.max(0,Ke),K.width-ye):Re==="center"?Ne?fe.x=(K.width-ye)/2:je?fe.x=(K.width-ye)/2+Ke:fe.x=Math.max(0,Math.min(K.width-ye,(K.width-ye)/2+Ke)):Re==="end"&&(Ne?fe.x=K.width-ye:fe.x=Math.max(0,Math.min(K.width-ye,K.width-ye+Ke)))}else if(we){fe.x=Ce==="left"?K.width:-ye;const je=ze===0,Ne=Math.abs(Y.height-K.height)>Math.abs(ze);Re==="start"?je?fe.y=0:fe.y=Math.min(Math.max(0,ze),K.height-Me):Re==="center"?je?fe.y=(K.height-Me)/2:Ne?fe.y=(K.height-Me)/2+ze:fe.y=Math.max(0,Math.min(K.height-Me,(K.height-Me)/2+ze)):Re==="end"&&(je?fe.y=K.height-Me:fe.y=Math.max(0,Math.min(K.height-Me,K.height-Me+ze)))}re.style.transform=j(fe.x,fe.y)}}function H(C){let F=arguments.length>1&&arguments[1]!==void 0?arguments[1]:[];if(!C)return[];const y=pe(C);if(y===C.ownerDocument.body){const ue=window.visualViewport?[window.visualViewport]:[],ce=V(y)?[y]:[];return[...F,window,...ue,...ce]}const re=H(he(y));return[...F,y,...re]}function he(C){return D(C)==="html"?C:C.parentNode}function V(C){const{overflow:F,overflowX:y,overflowY:oe,display:re}=getComputedStyle(C);return/auto|scroll|overlay|hidden|clip/.test(F+oe+y)&&!["contents"].includes(re)}const de=new Set(["html","body","#document"]);function pe(C){return de.has(D(C))?C.ownerDocument.body:V(C)?C:pe(he(C))}function D(C){return C?(C.nodeName||"").toLowerCase():null}function T(C){let F;return()=>(F||(F=new Promise(y=>{Promise.resolve().then(()=>{F=void 0,y(C())})})),F)}const q={direction:"bottom",enableFlip:!0,enableShift:!0,offset:0,zIndex:0,trigger:"hover",delay:100,clickOutsideClose:!0,disabled:!1},b={unmountOnExit:!0},ve={position:"absolute",top:0,left:0,bottom:"auto",right:"auto",margin:0,willChange:"transform"},Ee=W({},ve),_=W({},ve),ge=(0,n.forwardRef)((C,F)=>{const{prefixCls:y,componentConfig:oe}=(0,n.useContext)(k.E),{children:re,popper:ue,enableShift:ce,motion:Q={},enableFlip:Ie,offset:U,direction:me,getContainer:Y,zIndex:K,trigger:De,delay:Be,disabled:ae,visible:xe,arrow:ee,clickOutsideClose:le,onVisibleChange:se}=(0,r.S)(C,q,oe==null?void 0:oe.Trigger),we=(0,r.S)(b,Q),Ce=(0,n.isValidElement)(re),Le=(0,n.useRef)(null),$e=(0,n.useRef)(null),We=d(ue),Oe=(0,n.useRef)(null),Ze=(0,l.x1)(We,Oe),ie=(0,n.useRef)(null),[Se,Me]=(0,p.R)(xe,{onChange:se}),{genPopupProps:ye,genTriggerProps:Ke}=O({clickOutsideClose:le,delay:Be,disabled:ae,visible:Se,onVisibleChange:Me,trigger:De,triggerEl:Le.current});(0,n.useImperativeHandle)(F,()=>{});const ze=(0,l.t4)(re),Ye=(0,l.t4)(ue),Ge=(0,n.useCallback)(Re=>{var fe;Re&&Re.type!=="resize"&&!((fe=Re.target)!=null&&fe.contains(Le.current))||setTimeout(()=>{z({reference:Le.current,popper:Oe.current,arrow:$e.current},{direction:me,enableFlip:Ie,enableShift:ce,offset:U})})},[me,Ie,ce,U]),Fe=T(()=>new Promise(Re=>{Ge(),Re(void 0)}));if((0,s.L)(()=>{if(Se!==void 0){if(Fe(),Se===!0){var Re;(Re=ie.current)==null||Re.toggle(!0)}else if(Se===!1){var fe;(fe=ie.current)==null||fe.toggle(!1)}}},[Se]),(0,s.L)(()=>{Fe();const Re=H(Le.current),fe=H(Oe.current),je=[...Re,...fe];return je.forEach(Ne=>{Ne.addEventListener("scroll",Fe,{passive:!0})}),window.addEventListener("resize",Fe,{passive:!0}),()=>{je.forEach(Ne=>{Ne.removeEventListener("scroll",Fe)}),window.removeEventListener("resize",Fe)}},[me,Ie,ce,U,Oe.current,$e.current]),!Ce)return;const Je=()=>ue?n.createElement(J.Z,W({ref:ie},we),Re=>{let{className:fe}=Re;return n.createElement(w,{getContainer:Y},n.createElement("div",Pe(W({},ye()),{className:(0,m.default)(`${y}-trigger`,fe),style:Pe(W({},Ee),{zIndex:K})}),ee?n.createElement("div",{className:`${y}-trigger-arrow`},(0,n.cloneElement)(ee,{ref:$e,style:W(Pe(W({},_),{zIndex:K}),ee.props.style||{})})):null,(0,n.cloneElement)(ue,{ref:Ze})))}):null;return n.createElement(n.Fragment,null,n.createElement(i,{ref:Le,onResize:()=>Fe()},(0,n.cloneElement)(re,W({},Ke(re)))),Je())});ge.displayName="Trigger";const be=ge},36112:function(x,t,e){"use strict";e.r(t),e.d(t,{Trigger:function(){return a},default:function(){return v}});var n=e(67171),m=e(98479),r=e.n(m),p={};for(var s in m)["default","Trigger"].indexOf(s)<0&&(p[s]=function(I){return m[I]}.bind(0,s));e.d(t,p);const a=n.Z,v=a},98479:function(){},84176:function(x,t,e){var n=e(75863);function m(r,p){if(r==null)return{};var s=n(r,p),a,v;if(Object.getOwnPropertySymbols){var I=Object.getOwnPropertySymbols(r);for(v=0;v<I.length;v++)a=I[v],!(p.indexOf(a)>=0)&&Object.prototype.propertyIsEnumerable.call(r,a)&&(s[a]=r[a])}return s}x.exports=m,x.exports.__esModule=!0,x.exports.default=x.exports},75863:function(x){function t(e,n){if(e==null)return{};var m={},r=Object.keys(e),p,s;for(s=0;s<r.length;s++)p=r[s],!(n.indexOf(p)>=0)&&(m[p]=e[p]);return m}x.exports=t,x.exports.__esModule=!0,x.exports.default=x.exports},7829:function(x,t,e){"use strict";e.r(t),e.d(t,{clsx:function(){return m}});function n(r){var p,s,a="";if(typeof r=="string"||typeof r=="number")a+=r;else if(typeof r=="object")if(Array.isArray(r)){var v=r.length;for(p=0;p<v;p++)r[p]&&(s=n(r[p]))&&(a&&(a+=" "),a+=s)}else for(s in r)r[s]&&(a&&(a+=" "),a+=s);return a}function m(){for(var r,p,s=0,a="",v=arguments.length;s<v;s++)(r=arguments[s])&&(p=n(r))&&(a&&(a+=" "),a+=p);return a}t.default=m},64508:function(x,t,e){"use strict";e.d(t,{Y:function(){return p}});var n=e(53360),m=e(75601);const r=(s,a,v,I,h)=>{clearTimeout(I.current);const u=(0,m.y0)(s);a(u),v.current=u,h&&h({current:u})},p=({enter:s=!0,exit:a=!0,preEnter:v,preExit:I,timeout:h,initialEntered:u,mountOnEnter:c,unmountOnExit:d,onStateChange:l}={})=>{const[f,i]=(0,n.useState)(()=>(0,m.y0)(u?m.cn:(0,m.Ef)(c))),o=(0,n.useRef)(f),P=(0,n.useRef)(),[E,A]=(0,m.fj)(h),g=(0,n.useCallback)(()=>{const L=(0,m.XZ)(o.current._s,d);L&&r(L,i,o,P,l)},[l,d]),M=(0,n.useCallback)(L=>{const w=k=>{switch(r(k,i,o,P,l),k){case m.d0:E>=0&&(P.current=setTimeout(g,E));break;case m.Ix:A>=0&&(P.current=setTimeout(g,A));break;case m.iL:case m.iU:P.current=(0,m.Y3)(w,k);break}},J=o.current.isEnter;typeof L!="boolean"&&(L=!J),L?!J&&w(s?v?m.iL:m.d0:m.cn):J&&w(a?I?m.iU:m.Ix:(0,m.Ef)(d))},[g,l,s,a,v,I,E,A,d]);return[f,M,g]}},75601:function(x,t,e){"use strict";e.d(t,{Ef:function(){return u},Ix:function(){return s},XZ:function(){return c},Y3:function(){return l},cn:function(){return r},d0:function(){return m},fj:function(){return d},iL:function(){return n},iU:function(){return p},y0:function(){return h}});const n=0,m=1,r=2,p=3,s=4,a=5,v=6,I=["preEnter","entering","entered","preExit","exiting","exited","unmounted"],h=f=>({_s:f,status:I[f],isEnter:f<p,isMounted:f!==v,isResolved:f===r||f>s}),u=f=>f?v:a,c=(f,i)=>{switch(f){case m:case n:return r;case s:case p:return u(i)}},d=f=>typeof f=="object"?[f.enter,f.exit]:[f,f],l=(f,i)=>setTimeout(()=>{isNaN(document.body.offsetTop)||f(i+1)},0)}}]);
}());